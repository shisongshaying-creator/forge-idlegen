...
class RealmsSubscriptionTab extends GridLayoutTab implements RealmsConfigurationTab {
    ...
    RealmsSubscriptionTab(RealmsConfigureWorldScreen p_408051_, Minecraft p_405841_, RealmsServer p_407921_) {
        ...
        gridlayout$rowhelper.addChild(SpacerElement.height(2));
        this.subscriptionInfo = gridlayout$rowhelper.addChild(new FocusableTextWidget(200, Component.empty(), font), LayoutSettings.defaults().alignHorizontallyCenter());
    ...
    private static Component localPresentation(long p_407706_) {
        Calendar calendar = new GregorianCalendar(TimeZone.getDefault());
        calendar.setTimeInMillis(p_407706_);
