...
public class RealmsBackupInfoScreen extends RealmsScreen {
    ...
    class BackupInfoListEntry extends ObjectSelectionList.Entry<RealmsBackupInfoScreen.BackupInfoListEntry> {
        ...
        public void renderContent(GuiGraphics p_429898_, int p_423623_, int p_426194_, boolean p_430441_, float p_427873_) {
            p_429898_.drawString(RealmsBackupInfoScreen.this.font, this.translateKey(this.key), this.getContentX(), this.getContentY(), -6250336);
            p_429898_.drawString(
                RealmsBackupInfoScreen.this.font,
                RealmsBackupInfoScreen.this.checkForSpecificMetadata(this.key, this.value),
                this.getContentX(),
                this.getContentY() + 12,
                -1
            );
