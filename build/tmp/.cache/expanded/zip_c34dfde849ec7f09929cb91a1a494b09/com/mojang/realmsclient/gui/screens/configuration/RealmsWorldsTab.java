    ...
    RealmsWorldsTab(RealmsConfigureWorldScreen p_410270_, Minecraft p_407127_, RealmsServer p_408890_) {
        ...
        this.optionsButton = gridlayout$rowhelper2.addChild(
            Button.builder(
                    ...
                    p_409068_ -> p_407127_.setScreen(
                        new RealmsSlotOptionsScreen(p_410270_, p_408890_.slots.get(p_408890_.activeSlot).clone(), p_408890_.worldType, p_408890_.activeSlot)
                    )
                )
                .bounds(0, 0, 150, 20)
                .build()
        ...
        this.backupButton = gridlayout$rowhelper2.addChild(
            Button.builder(
                    ...
                    p_408278_ -> p_407127_.setScreen(new RealmsBackupScreen(p_410270_, p_408890_.clone(), p_408890_.activeSlot))
                )
                .bounds(0, 0, 150, 20)
                .build()
        );
