...
public class GlCommandEncoder implements CommandEncoder {
    ...
    protected <T> void executeDrawMultiple(
        ...
        @Nullable VertexFormat.IndexType p_395864_,
    ...
    private void drawFromBuffers(
        ...
        int p_409156_,
        int p_406701_,
        @Nullable VertexFormat.IndexType p_407030_,
    ...
    private boolean trySetup(GlRenderPass p_396081_, Collection<String> p_408722_) {
        if (GlRenderPass.VALIDATION) {
            ...
            for (Entry<String, Uniform> entry1 : p_396081_.pipeline.program().getUniforms().entrySet()) {
                if (entry1.getValue() instanceof Uniform.Sampler) {
                    String s1 = entry1.getKey();
                    GlTextureView gltextureview = (GlTextureView)p_396081_.samplers.get(s1);
        ...
        for (Entry<String, Uniform> entry : glprogram.getUniforms().entrySet()) {
            ...
            switch ((Uniform)entry.getValue()) {
                ...
                case Uniform.Sampler(int $$22, int l1):
                    int k1 = l1;
                    GlTextureView gltextureview1 = (GlTextureView)p_396081_.samplers.get(s);
