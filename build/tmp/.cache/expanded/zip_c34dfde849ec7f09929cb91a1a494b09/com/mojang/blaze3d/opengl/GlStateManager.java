...
public class GlStateManager {
    ...
    public static void glShaderSource(int p_393940_, String p_391652_) {
        RenderSystem.assertOnRenderThread();
        byte[] abyte = p_391652_.getBytes(Charsets.UTF_8);
    ...
    public static void _glBufferSubData(int p_393265_, int p_391452_, ByteBuffer p_393357_) {
        RenderSystem.assertOnRenderThread();
        GL15.glBufferSubData(p_393265_, (long)p_391452_, p_393357_);
    }
    ...
    @Nullable
    public static ByteBuffer _glMapBufferRange(int p_396635_, int p_392421_, int p_392666_, int p_395186_) {
        RenderSystem.assertOnRenderThread();
        return GL30.glMapBufferRange(p_396635_, p_392421_, p_392666_, p_395186_);
    }
