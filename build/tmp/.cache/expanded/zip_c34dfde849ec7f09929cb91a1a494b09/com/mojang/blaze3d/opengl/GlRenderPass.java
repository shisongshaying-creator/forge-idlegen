...
public class GlRenderPass implements RenderPass {
    ...
    @Override
    public void bindSampler(String p_392583_, @Nullable GpuTextureView p_410174_) {
        if (p_410174_ == null) {
            this.samplers.remove(p_392583_);
        } else {
            this.samplers.put(p_392583_, p_410174_);
        }

        this.dirtyUniforms.add(p_392583_);
    }
    ...
    public <T> void drawMultipleIndexed(
        ...
        @Nullable VertexFormat.IndexType p_391410_,
