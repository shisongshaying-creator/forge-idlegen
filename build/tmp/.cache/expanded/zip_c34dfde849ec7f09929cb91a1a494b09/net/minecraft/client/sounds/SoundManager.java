...
public class SoundManager extends SimplePreparableReloadListener<SoundManager.Preparations> {
    ...
    public SoundManager(Options p_250027_, MusicManager p_409684_) {
        this.soundEngine = new SoundEngine(p_409684_, this, p_250027_, ResourceProvider.fromMap(this.soundCache));
    }
    ...
    public void updateSourceVolume(SoundSource p_120359_) {
        this.soundEngine.updateCategoryVolume(p_120359_);
    }
