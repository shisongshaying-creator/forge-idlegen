...
public class StringSplitter {
    ...
    public int formattedIndexByWidth(String p_168627_, int p_168628_, Style p_168629_) {
        StringSplitter.WidthLimitedCharSink stringsplitter$widthlimitedcharsink = new StringSplitter.WidthLimitedCharSink(p_168628_);
    ...
    public Style componentStyleAtWidth(FormattedText p_92387_, int p_92388_) {
        StringSplitter.WidthLimitedCharSink stringsplitter$widthlimitedcharsink = new StringSplitter.WidthLimitedCharSink(p_92388_);
    ...
    public Style componentStyleAtWidth(FormattedCharSequence p_92339_, int p_92340_) {
        StringSplitter.WidthLimitedCharSink stringsplitter$widthlimitedcharsink = new StringSplitter.WidthLimitedCharSink(p_92340_);
