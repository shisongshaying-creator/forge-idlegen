...
public class HappyGhastModel extends EntityModel<HappyGhastRenderState> {
    ...
    public static LayerDefinition createBodyLayer(boolean p_408416_, CubeDeformation p_407953_) {
        MeshDefinition meshdefinition = new MeshDefinition();
        PartDefinition partdefinition = meshdefinition.getRoot();
        PartDefinition partdefinition1 = partdefinition.addOrReplaceChild(
            "body",
            CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -8.0F, -8.0F, 16.0F, 16.0F, 16.0F, p_407953_),
            PartPose.offset(0.0F, 16.0F, 0.0F)
        );
        if (p_408416_) {
            partdefinition1.addOrReplaceChild(
                "inner_body",
                CubeListBuilder.create().texOffs(0, 32).addBox(-8.0F, -16.0F, -8.0F, 16.0F, 16.0F, 16.0F, p_407953_.extend(-0.5F)),
        ...
        partdefinition1.addOrReplaceChild(
            ...
            CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, p_407953_),
            PartPose.offset(-3.75F, 7.0F, -5.0F)
        );
        partdefinition1.addOrReplaceChild(
            PartNames.tentacle(1),
            CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, p_407953_),
            PartPose.offset(1.25F, 7.0F, -5.0F)
        );
        partdefinition1.addOrReplaceChild(
            PartNames.tentacle(2),
            CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, p_407953_),
        ...
        partdefinition1.addOrReplaceChild(
            ...
            CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, p_407953_),
            PartPose.offset(-3.75F, 7.0F, 5.0F)
        );
        partdefinition1.addOrReplaceChild(
