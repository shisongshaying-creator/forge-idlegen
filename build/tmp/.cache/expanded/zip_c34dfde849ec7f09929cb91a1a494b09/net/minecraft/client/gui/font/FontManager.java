...
public class FontManager implements PreparableReloadListener, AutoCloseable {
    ...
    private FontSet createFontSet(ResourceLocation p_428107_, List<GlyphProvider.Conditional> p_424996_, Set<FontOption> p_427683_) {
        GlyphStitcher glyphstitcher = new GlyphStitcher(this.textureManager, p_428107_);
    ...
    private void apply(FontManager.Preparation p_284939_, ProfilerFiller p_285407_) {
        ...
        p_284939_.fontSets()
            .forEach(
                (p_420724_, p_420725_) -> this.fontSets
                    .put(p_420724_, this.createFontSet(p_420724_, Lists.reverse((List<GlyphProvider.Conditional>)p_420725_), set))
            );
        ...
        if (!this.fontSets.containsKey(Minecraft.DEFAULT_FONT)) {
            ...
            this.atlasManager.forEach((p_420721_, p_420722_) -> this.atlasProviders.put(p_420721_, new AtlasGlyphProvider(p_420722_)));
        }
    }
    ...
    FontSet getFontSetRaw(ResourceLocation p_333296_) {
