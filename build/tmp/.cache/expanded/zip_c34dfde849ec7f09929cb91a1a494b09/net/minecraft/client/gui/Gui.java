...
public class Gui {
    ...
    public Gui(Minecraft p_330021_) {
        ...
        net.minecraftforge.client.gui.overlay.ForgeLayeredDraw.init(this, p_330021_);
    }
    ...
    public void render(GuiGraphics p_282884_, DeltaTracker p_342095_) {
        if (!(this.minecraft.screen instanceof LevelLoadingScreen)) {
            if (Boolean.valueOf(true)) {
                net.minecraftforge.client.gui.overlay.ForgeLayeredDraw.beginRender(p_282884_, p_342095_);
                return;
            }
    ...
    public void renderBossOverlay(GuiGraphics p_407400_, DeltaTracker p_407876_) {
    ...
    public void renderSubtitleOverlay(GuiGraphics p_406760_, boolean p_422895_) {
        if (p_422895_) {
    ...
    public void renderCameraOverlays(GuiGraphics p_333627_, DeltaTracker p_344236_) {
    ...
    public void renderSleepOverlay(GuiGraphics p_329087_, DeltaTracker p_345225_) {
    ...
    public void renderOverlayMessage(GuiGraphics p_330258_, DeltaTracker p_345514_) {
    ...
    public void renderTitle(GuiGraphics p_331218_, DeltaTracker p_344700_) {
    ...
    public void renderChat(GuiGraphics p_329202_, DeltaTracker p_342328_) {
    ...
    public void renderScoreboardSidebar(GuiGraphics p_332744_, DeltaTracker p_344235_) {
    ...
    public void renderTabList(GuiGraphics p_330031_, DeltaTracker p_343599_) {
        Scoreboard scoreboard = this.minecraft.level.getScoreboard();
    ...
    public void renderCrosshair(GuiGraphics p_282828_, DeltaTracker p_343490_) {
    ...
    public boolean canRenderCrosshairForSpectator(@Nullable HitResult p_93025_) {
        if (p_93025_ == null) {
            return false;
    ...
    public void renderEffects(GuiGraphics p_282812_, DeltaTracker p_343719_) {
    ...
    public void renderHotbarAndDecorations(GuiGraphics p_333625_, DeltaTracker p_344796_) {
    ...
    public void renderItemHotbar(GuiGraphics p_332738_, DeltaTracker p_342619_) {
    ...
    public void renderDemoOverlay(GuiGraphics p_281825_, DeltaTracker p_343325_) {
        if (this.minecraft.isDemo()) {
    ...
    public int getVehicleMaxHearts(@Nullable LivingEntity p_93023_) {
    ...
    public int getVisibleVehicleHeartRows(int p_93013_) {
        return (int)Math.ceil(p_93013_ / 10.0);
    }

    public void renderPlayerHealth(GuiGraphics p_283143_) {
        Player player = this.getCameraPlayer();
        if (player != null) {
    ...
    public static void renderArmor(GuiGraphics p_332897_, Player p_332999_, int p_330861_, int p_331335_, int p_329919_, int p_329454_) {
    ...
    public void renderHeart(GuiGraphics p_283024_, Gui.HeartType p_281393_, int p_283636_, int p_283279_, boolean p_283440_, boolean p_282496_, boolean p_301416_) {
    ...
    public void renderAirBubbles(GuiGraphics p_362039_, Player p_362951_, int p_361107_, int p_367174_, int p_368454_) {
    ...
    public int getAirBubbleYLine(int p_366666_, int p_361146_) {
        int i = this.getVisibleVehicleHeartRows(p_366666_) - 1;
        return p_361146_ - i * 10;
    }

    public static int getCurrentAirSupplyBubble(int p_364683_, int p_367314_, int p_368617_) {
        return Mth.ceil((float)((p_364683_ + p_368617_) * 10) / p_367314_);
    }

    public static int getEmptyBubbleDelayDuration(int p_363282_, boolean p_362908_) {
        return p_363282_ != 0 && p_362908_ ? 1 : 0;
    }

    public void playAirBubblePoppedSound(int p_360863_, Player p_365458_, int p_362524_) {
    ...
    public void renderFood(GuiGraphics p_330960_, Player p_328268_, int p_331606_, int p_330339_) {
    ...
    public void renderVehicleHealth(GuiGraphics p_283368_) {
        LivingEntity livingentity = this.getPlayerVehicleWithHealth();
    ...
    public void renderTextureOverlay(GuiGraphics p_282304_, ResourceLocation p_281622_, float p_281504_) {
    ...
    public void updateVignetteBrightness(Entity p_93021_) {
    ...
    public void renderPortalOverlay(GuiGraphics p_283375_, float p_283296_) {
        if (p_283296_ < 1.0F) {
            p_283296_ *= p_283296_;
            p_283296_ *= p_283296_;
    ...
    public void renderConfusionOverlay(GuiGraphics p_365616_, float p_366912_) {
    ...
    public void renderSlot(GuiGraphics p_283283_, int p_283213_, int p_281301_, DeltaTracker p_344149_, Player p_283644_, ItemStack p_283317_, int p_283261_) {
    ...
    public Gui.ContextualInfo nextContextualInfoState() {
