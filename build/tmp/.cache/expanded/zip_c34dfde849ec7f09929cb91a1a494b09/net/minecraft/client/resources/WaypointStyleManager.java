...
public class WaypointStyleManager extends SimpleJsonResourceReloadListener<WaypointStyle> {
    ...
    protected void apply(Map<ResourceLocation, WaypointStyle> p_408124_, ResourceManager p_409101_, ProfilerFiller p_409080_) {
        this.waypointStyles = p_408124_.entrySet()
            .stream()
            .collect(Collectors.toUnmodifiableMap(p_410428_ -> ResourceKey.create(WaypointStyleAssets.ROOT_ID, p_410428_.getKey()), Entry::getValue));
    }
