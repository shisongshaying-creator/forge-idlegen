...
public class ModelPartFeatureRenderer {
    ...
    public static class Storage {
        ...
        public void add(RenderType p_423498_, SubmitNodeStorage.ModelPartSubmit p_428026_) {
            this.modelPartSubmits.computeIfAbsent(p_423498_, p_428430_ -> new ArrayList<>()).add(p_428026_);
        }
        ...
        public void endFrame() {
            this.modelPartSubmits.keySet().removeIf(p_428521_ -> !this.modelPartSubmitsUsage.contains(p_428521_));
