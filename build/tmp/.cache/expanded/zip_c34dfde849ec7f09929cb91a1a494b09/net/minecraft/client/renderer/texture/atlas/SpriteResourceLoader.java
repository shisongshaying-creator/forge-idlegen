    ...
    static SpriteResourceLoader create(Set<MetadataSectionType<?>> p_423718_) {
        return (p_421043_, p_421044_) -> {
            ...
            try {
                ...
                LOGGER.error("Unable to parse metadata from {}", p_421043_, exception);
                return null;
            }
            ...
            try (InputStream inputstream = p_421044_.open()) {
                ...
                LOGGER.error("Using missing texture, unable to load {}", p_421043_, ioexception);
                return null;
            }
            ...
            SpriteContents contents = net.minecraftforge.client.ForgeHooksClient.loadSpriteContents(p_421043_, p_421044_, framesize, nativeimage, list);
