...
public class SubmitNodeCollection implements OrderedSubmitNodeCollector {
    ...
    @Override
    public void submitHitbox(PoseStack p_429027_, EntityRenderState p_422521_, HitboxesRenderState p_423230_) {
        this.wasUsed = true;
        this.hitboxSubmits.add(new SubmitNodeStorage.HitboxSubmit(new Matrix4f(p_429027_.last().pose()), p_422521_, p_423230_));
    }
    ...
    public <S> void submitModel(
        ...
        S p_422625_,
        PoseStack p_424450_,
        RenderType p_429022_,
        int p_426738_,
        int p_424372_,
        int p_423869_,
        @Nullable TextureAtlasSprite p_423183_,
        int p_426567_,
        @Nullable ModelFeatureRenderer.CrumblingOverlay p_424580_
    ) {
        this.wasUsed = true;
        ...
        this.modelSubmits.add(p_429022_, modelsubmit);
    }
    ...
    public void submitModelPart(
        ...
        boolean p_422462_,
        int p_425817_,
        @Nullable ModelFeatureRenderer.CrumblingOverlay p_430912_,
        int p_431872_
    ) {
        this.wasUsed = true;
        ...
        this.blockModelSubmits
            .add(
                new SubmitNodeStorage.BlockModelSubmit(
                    p_426724_.last().copy(), p_430846_, p_430042_, p_426641_, p_429457_, p_423466_, p_422478_, p_423902_, p_424810_
                )
            );
    }
        ...
        this.itemSubmits
            .add(
                new SubmitNodeStorage.ItemSubmit(
                    p_427089_.last().copy(), p_422921_, p_425776_, p_428806_, p_431657_, p_426729_, p_425892_, p_428510_, p_428652_
                )
            );
    }

    @Override
    public void submitCustomGeometry(PoseStack p_431589_, RenderType p_429453_, SubmitNodeCollector.CustomGeometryRenderer p_431193_) {
        this.wasUsed = true;
        this.customGeometrySubmits.add(p_431589_, p_429453_, p_431193_);
    }
