...
public class GuiGraphics implements net.minecraftforge.client.extensions.IForgeGuiGraphics {
    ...
    public void submitOutline(int p_429156_, int p_426038_, int p_430849_, int p_428380_, int p_430897_) {
        this.deferredOutlines.add(new GuiGraphics.OutlineBox(p_429156_, p_426038_, p_430849_, p_428380_, p_430897_));
    }
    ...
    public void blitSprite(RenderPipeline p_406925_, ResourceLocation p_300860_, int p_298718_, int p_298541_, int p_300996_, int p_298426_, int p_364958_) {
        TextureAtlasSprite textureatlassprite = this.guiSprites.getSprite(p_300860_);
    ...
    public void blitSprite(
        ...
        TextureAtlasSprite textureatlassprite = this.guiSprites.getSprite(p_364214_);
        GuiSpriteScaling guispritescaling = getSpriteScaling(textureatlassprite);
    ...
    private void blitTiledSprite(
        ...
        if (p_297241_ > 0 && p_300646_ > 0) {
            if (p_299557_ > 0 && p_297684_ > 0) {
                GpuTextureView gputextureview = this.minecraft.getTextureManager().getTexture(p_298835_.atlasLocation()).getTextureView();
        ...
        this.guiRenderState
            .submitGuiElement(
                new TiledBlitRenderState(
                    p_427986_,
                    TextureSetup.singleTexture(p_426152_),
                    new Matrix3x2f(this.pose),
                    p_423047_,
                    p_430570_,
                    p_424688_,
    ...
    public void renderComponentHoverEffect(Font p_282584_, @Nullable Style p_282156_, int p_283623_, int p_282114_) {
        if (p_282156_ != null) {
            if (p_282156_.getClickEvent() != null) {
    ...
    public void submitBannerPatternRenderState(
        BannerFlagModel p_422569_, DyeColor p_408541_, BannerPatternLayers p_406492_, int p_408397_, int p_406537_, int p_410642_, int p_408792_
    ) {
        this.guiRenderState
            .submitPicturesInPictureState(new GuiBannerResultRenderState(p_422569_, p_408541_, p_406492_, p_408397_, p_406537_, p_410642_, p_408792_, this.scissorStack.peek()));
    }
    ...
    record OutlineBox(int x, int y, int width, int height, int color) {
        public void render(GuiGraphics p_422648_) {
            p_422648_.fill(this.x, this.y, this.x + this.width, this.y + 1, this.color);
            p_422648_.fill(
                this.x, this.y + this.height - 1, this.x + this.width, this.y + this.height, this.color
            );
            p_422648_.fill(this.x, this.y + 1, this.x + 1, this.y + this.height - 1, this.color);
            p_422648_.fill(
                this.x + this.width - 1, this.y + 1, this.x + this.width, this.y + this.height - 1, this.color
            );
        }
    }
