...
public class WardenModel extends EntityModel<WardenRenderState> {
    ...
    public static LayerDefinition createTendrilsLayer() {
        return createBodyLayer().apply(p_430998_ -> {
            p_430998_.getRoot().retainExactParts(Set.of("left_tendril", "right_tendril"));
            return p_430998_;
        });
    }

    public static LayerDefinition createHeartLayer() {
        return createBodyLayer().apply(p_430876_ -> {
            p_430876_.getRoot().retainExactParts(Set.of("body"));
            return p_430876_;
        });
    }

    public static LayerDefinition createBioluminescentLayer() {
        return createBodyLayer().apply(p_427398_ -> {
            p_427398_.getRoot().retainExactParts(Set.of("head", "left_arm", "right_arm", "left_leg", "right_leg"));
            return p_427398_;
        });
    }

    public static LayerDefinition createPulsatingSpotsLayer() {
        return createBodyLayer().apply(p_423789_ -> {
            p_423789_.getRoot().retainExactParts(Set.of("body", "head", "left_arm", "right_arm", "left_leg", "right_leg"));
            return p_423789_;
        });
    }
    ...
    public void setupAnim(WardenRenderState p_366602_) {
        ...
        this.attackAnimation.apply(p_366602_.attackAnimationState, p_366602_.ageInTicks);
        this.sonicBoomAnimation.apply(p_366602_.sonicBoomAnimationState, p_366602_.ageInTicks);
        this.diggingAnimation.apply(p_366602_.diggingAnimationState, p_366602_.ageInTicks);
        this.emergeAnimation.apply(p_366602_.emergeAnimationState, p_366602_.ageInTicks);
        this.roarAnimation.apply(p_366602_.roarAnimationState, p_366602_.ageInTicks);
        this.sniffAnimation.apply(p_366602_.sniffAnimationState, p_366602_.ageInTicks);
    }
