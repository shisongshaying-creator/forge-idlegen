...
public class AbstractPiglinModel<S extends HumanoidRenderState> extends HumanoidModel<S> {
    ...
    public static ArmorModelSet<MeshDefinition> createArmorMeshSet(CubeDeformation p_431740_, CubeDeformation p_429800_) {
        return PlayerModel.createArmorMeshSet(p_431740_, p_429800_).map(p_428986_ -> {
            PartDefinition partdefinition = p_428986_.getRoot();
            ...
            return (MeshDefinition)p_428986_;
        });
    }
