...
public class Font implements net.minecraftforge.client.extensions.IForgeFont {
    ...
    public interface GlyphVisitor {
        static Font.GlyphVisitor forMultiBufferSource(final MultiBufferSource p_409617_, final Matrix4f p_408497_, final Font.DisplayMode p_409313_, final int p_408611_) {
            return new Font.GlyphVisitor() {
                @Override
                public void acceptGlyph(TextRenderable p_428245_) {
                    this.render(p_428245_);
                }
        ...
        void acceptGlyph(TextRenderable p_427150_);

        void acceptEffect(TextRenderable p_430311_);
    }
    ...
    class PreparedTextBuilder implements FormattedCharSink, Font.PreparedText {
        ...
        private void addGlyph(TextRenderable p_424722_) {
            this.glyphs.add(p_424722_);
            this.markSize(p_424722_.left(), p_424722_.top(), p_424722_.right(), p_424722_.bottom());
        }
        ...
        public boolean accept(int p_422572_, Style p_423260_, BakedGlyph p_426975_) {
            ...
            TextRenderable textrenderable = p_426975_.createGlyph(this.x, this.y, i, j, p_423260_, f3, f2);
        ...
        public void visit(Font.GlyphVisitor p_407346_) {
            ...
            for (TextRenderable textrenderable : this.glyphs) {
                p_407346_.acceptGlyph(textrenderable);
            }

            if (this.effects != null) {
                for (TextRenderable textrenderable1 : this.effects) {
                    p_407346_.acceptEffect(textrenderable1);
                }
            }
        }
