...
public class ColdPigModel extends PigModel {
    public ColdPigModel(ModelPart p_393885_) {
        super(p_393885_);
    }

    public static LayerDefinition createBodyLayer(CubeDeformation p_395479_) {
        MeshDefinition meshdefinition = createBasePigModel(p_395479_);
