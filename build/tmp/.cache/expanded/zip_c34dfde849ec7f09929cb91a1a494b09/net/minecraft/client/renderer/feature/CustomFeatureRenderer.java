...
public class CustomFeatureRenderer {
    ...
    public static class Storage {
        ...
        public void add(PoseStack p_424712_, RenderType p_426437_, SubmitNodeCollector.CustomGeometryRenderer p_428692_) {
            List<SubmitNodeStorage.CustomGeometrySubmit> list = this.customGeometrySubmits.computeIfAbsent(p_426437_, p_429678_ -> new ArrayList<>());
        ...
        public void endFrame() {
            this.customGeometrySubmits.keySet().removeIf(p_428795_ -> !this.customGeometrySubmitsUsage.contains(p_428795_));
