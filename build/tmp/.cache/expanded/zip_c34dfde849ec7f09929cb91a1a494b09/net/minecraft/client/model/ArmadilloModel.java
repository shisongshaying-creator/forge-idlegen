...
public class ArmadilloModel extends EntityModel<ArmadilloRenderState> {
    ...
    public ArmadilloModel(ModelPart p_329798_) {
        ...
        this.walkAnimation = ArmadilloAnimation.ARMADILLO_WALK.bake(p_329798_);
        this.rollOutAnimation = ArmadilloAnimation.ARMADILLO_ROLL_OUT.bake(p_329798_);
        this.rollUpAnimation = ArmadilloAnimation.ARMADILLO_ROLL_UP.bake(p_329798_);
        this.peekAnimation = ArmadilloAnimation.ARMADILLO_PEEK.bake(p_329798_);
    }
    ...
    public void setupAnim(ArmadilloRenderState p_363759_) {
        ...
        this.walkAnimation.applyWalk(p_363759_.walkAnimationPos, p_363759_.walkAnimationSpeed, 16.5F, 2.5F);
        this.rollOutAnimation.apply(p_363759_.rollOutAnimationState, p_363759_.ageInTicks);
        this.rollUpAnimation.apply(p_363759_.rollUpAnimationState, p_363759_.ageInTicks);
        this.peekAnimation.apply(p_363759_.peekAnimationState, p_363759_.ageInTicks);
    }
}