...
public class DripParticle extends SingleQuadParticle {
    ...
    static class FallingParticle extends DripParticle {
        FallingParticle(ClientLevel p_106132_, double p_106133_, double p_106134_, double p_106135_, Fluid p_106136_, TextureAtlasSprite p_431130_) {
            this(p_106132_, p_106133_, p_106134_, p_106135_, p_106136_, (int)(64.0 / (Math.random() * 0.8 + 0.2)), p_431130_);
        }

        FallingParticle(
            ClientLevel p_172022_, double p_172023_, double p_172024_, double p_172025_, Fluid p_172026_, int p_172027_, TextureAtlasSprite p_427921_
        ) {
            super(p_172022_, p_172023_, p_172024_, p_172025_, p_172026_, p_427921_);
    ...
    public static class SporeBlossomFallProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            int i = (int)(64.0F / Mth.randomBetween(p_425919_.getRandom(), 0.1F, 0.9F));
            DripParticle dripparticle = new DripParticle.FallingParticle(
                p_425919_, p_422663_, p_430981_, p_427973_, Fluids.EMPTY, i, this.sprite.get(p_431187_)
            );
