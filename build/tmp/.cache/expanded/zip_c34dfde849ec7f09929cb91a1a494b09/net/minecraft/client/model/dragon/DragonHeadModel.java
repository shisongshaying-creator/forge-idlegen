...
public class DragonHeadModel extends SkullModelBase {
    ...
    public void setupAnim(SkullModelBase.State p_426374_) {
        super.setupAnim(p_426374_);
        this.jaw.xRot = (float)(Math.sin(p_426374_.animationPos * (float) Math.PI * 0.2F) + 1.0) * 0.2F;
        this.head.yRot = p_426374_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_426374_.xRot * (float) (Math.PI / 180.0);
    }
}