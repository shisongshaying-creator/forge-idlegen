...
public class BookModel extends Model<BookModel.State> {
    ...
    public void setupAnim(BookModel.State p_431258_) {
        super.setupAnim(p_431258_);
        float f = (Mth.sin(p_431258_.animationPos * 0.02F) * 0.1F + 1.25F) * p_431258_.open;
        this.leftLid.yRot = (float) Math.PI + f;
        this.rightLid.yRot = -f;
        this.leftPages.yRot = f;
        this.rightPages.yRot = -f;
        this.flipPage1.yRot = f - f * 2.0F * p_431258_.pageFlip1;
        this.flipPage2.yRot = f - f * 2.0F * p_431258_.pageFlip2;
