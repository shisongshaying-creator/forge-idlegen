...
public class DialogBodyHandlers {
    ...
    @Nullable
    private static <B extends DialogBody> DialogBodyHandler<B> getHandler(B p_407699_) {
        return (DialogBodyHandler<B>)HANDLERS.get(p_407699_.mapCodec());
    }

    @Nullable
    public static <B extends DialogBody> LayoutElement createBodyElement(DialogScreen<?> p_406596_, B p_407924_) {
            ...
            if (p_410433_.description().isPresent()) {
                ...
                linearlayout.addChild(
                    new FocusableTextWidget(
                            plainmessage.width(), plainmessage.contents(), p_409486_.getFont(), false, FocusableTextWidget.BackgroundFill.NEVER, 4
                        )
    ...
    static class PlainMessageHandler implements DialogBodyHandler<PlainMessage> {
        public LayoutElement createControls(DialogScreen<?> p_405971_, PlainMessage p_408125_) {
            return new FocusableTextWidget(
                    p_408125_.width(), p_408125_.contents(), p_405971_.getFont(), false, FocusableTextWidget.BackgroundFill.NEVER, 4
                )
