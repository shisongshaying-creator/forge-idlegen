...
public class LocalPlayer extends AbstractClientPlayer {
    ...
    public boolean startRiding(Entity p_108667_, boolean p_108668_, boolean p_423004_) {
        if (!super.startRiding(p_108667_, p_108668_, p_423004_)) {
            ...
            if (p_108667_ instanceof AbstractMinecart) {
                ...
                this.minecraft.getSoundManager().play(new RidingHappyGhastSoundInstance(this, (HappyGhast)p_108667_));
            }
    ...
    private boolean isSprintingPossible(boolean p_425414_) {
        return !this.isMobilityRestricted() && this.hasEnoughFoodToSprint() && (!this.isPassenger() || this.vehicleCanSprint(this.getVehicle())) && (p_425414_ || !this.isInShallowWater());
    }
