...
public class LiquidBlockRenderer {
    ...
    protected void setupSprites(BlockModelShaper p_429425_, MaterialSet p_425342_) {
        this.lavaIcons[0] = p_429425_.getBlockModel(Blocks.LAVA.defaultBlockState()).particleIcon();
        this.lavaIcons[1] = p_425342_.get(ModelBakery.LAVA_FLOW);
        this.waterIcons[0] = p_429425_.getBlockModel(Blocks.WATER.defaultBlockState()).particleIcon();
        this.waterIcons[1] = p_425342_.get(ModelBakery.WATER_FLOW);
        this.waterOverlay = p_425342_.get(ModelBakery.WATER_OVERLAY);
    }
