...
public abstract class NeedleDirectionHelper {
    ...
    public float get(ItemStack p_377286_, @Nullable ClientLevel p_378790_, @Nullable ItemOwner p_431484_, int p_375400_) {
        ...
        if (p_431484_ == null) {
            ...
            if (p_378790_ == null && p_431484_ != null && p_431484_.level() instanceof ClientLevel clientlevel) {
    ...
    protected abstract float calculate(ItemStack p_378355_, ClientLevel p_377407_, int p_377397_, @Nullable ItemOwner p_422598_);
