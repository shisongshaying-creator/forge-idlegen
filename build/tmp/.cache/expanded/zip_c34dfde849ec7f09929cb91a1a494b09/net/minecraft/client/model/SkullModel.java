...
public class SkullModel extends SkullModelBase {
    ...
    public void setupAnim(SkullModelBase.State p_430661_) {
        super.setupAnim(p_430661_);
        this.head.yRot = p_430661_.yRot * (float) (Math.PI / 180.0);
        this.head.xRot = p_430661_.xRot * (float) (Math.PI / 180.0);
    }
}