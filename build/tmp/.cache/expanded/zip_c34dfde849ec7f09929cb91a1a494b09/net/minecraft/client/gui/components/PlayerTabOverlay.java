...
public class PlayerTabOverlay {
    ...
    protected void renderPingIcon(GuiGraphics p_283286_, int p_281809_, int p_282801_, int p_282223_, PlayerInfo p_282986_) {
        ...
        p_283286_.blitSprite(RenderPipelines.GUI_TEXTURED, resourcelocation, p_282801_ + p_281809_ - 11, p_282223_, 10, 8);
    }
    ...
    private void renderTablistHearts(int p_282904_, int p_283173_, int p_282149_, UUID p_283348_, GuiGraphics p_281723_, int p_281354_) {
        ...
        if (i > 0) {
            ...
            if (k <= 3) {
                ...
                for (int l = i; l < j; l++) {
                    p_281723_.blitSprite(RenderPipelines.GUI_TEXTURED, resourcelocation, p_283173_ + l * k, p_282904_, 9, 9);
                }

                for (int i1 = 0; i1 < i; i1++) {
                    p_281723_.blitSprite(RenderPipelines.GUI_TEXTURED, resourcelocation, p_283173_ + i1 * k, p_282904_, 9, 9);
                    if (flag) {
