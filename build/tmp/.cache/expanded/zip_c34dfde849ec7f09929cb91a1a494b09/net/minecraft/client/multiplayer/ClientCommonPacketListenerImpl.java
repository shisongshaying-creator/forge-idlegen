...
public abstract class ClientCommonPacketListenerImpl implements ClientCommonPacketListener {
    ...
    protected abstract class CommonDialogAccess implements DialogConnectionAccess {
        ...
        @Override
        public void sendCustomAction(ResourceLocation p_431760_, Optional<Tag> p_425632_) {
            ClientCommonPacketListenerImpl.this.send(new ServerboundCustomClickActionPacket(p_431760_, p_425632_));
        }
