...
public class CreakingModel extends EntityModel<CreakingRenderState> {
    ...
    public void setupAnim(CreakingRenderState p_362230_) {
        ...
        if (p_362230_.canMove) {
            this.walkAnimation.applyWalk(p_362230_.walkAnimationPos, p_362230_.walkAnimationSpeed, 1.0F, 1.0F);
        }

        this.attackAnimation.apply(p_362230_.attackAnimationState, p_362230_.ageInTicks);
        this.invulnerableAnimation.apply(p_362230_.invulnerabilityAnimationState, p_362230_.ageInTicks);
        this.deathAnimation.apply(p_362230_.deathAnimationState, p_362230_.ageInTicks);
    }
}