...
public class BlockModelGenerators {
    ...
    protected void createCopperLantern(Block p_431171_, Block p_427547_) {
        ResourceLocation resourcelocation = TexturedModel.LANTERN.create(p_431171_, this.modelOutput);
        ResourceLocation resourcelocation1 = TexturedModel.HANGING_LANTERN.create(p_431171_, this.modelOutput);
        this.registerSimpleFlatItemModel(p_431171_.asItem());
        this.itemModelOutput.copy(p_431171_.asItem(), p_427547_.asItem());
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.dispatch(p_431171_)
                    .with(createBooleanModelDispatch(BlockStateProperties.HANGING, plainVariant(resourcelocation1), plainVariant(resourcelocation)))
            );
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.dispatch(p_427547_)
                    .with(createBooleanModelDispatch(BlockStateProperties.HANGING, plainVariant(resourcelocation1), plainVariant(resourcelocation)))
            );
    }
    ...
    protected void createBarsAndItem(Block p_429832_, Block p_431273_) {
        ...
        ResourceLocation resourcelocation = ModelTemplates.BARS_POST_ENDS.create(p_429832_, texturemapping, this.modelOutput);
        ResourceLocation resourcelocation1 = ModelTemplates.BARS_POST.create(p_429832_, texturemapping, this.modelOutput);
        ResourceLocation resourcelocation2 = ModelTemplates.BARS_CAP.create(p_429832_, texturemapping, this.modelOutput);
        ResourceLocation resourcelocation3 = ModelTemplates.BARS_CAP_ALT.create(p_429832_, texturemapping, this.modelOutput);
        ResourceLocation resourcelocation4 = ModelTemplates.BARS_POST_SIDE.create(p_429832_, texturemapping, this.modelOutput);
        ResourceLocation resourcelocation5 = ModelTemplates.BARS_POST_SIDE_ALT.create(p_429832_, texturemapping, this.modelOutput);
        this.createBars(p_429832_, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, resourcelocation4, resourcelocation5);
        this.createBars(p_431273_, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, resourcelocation4, resourcelocation5);
    ...
    protected void createBars(
        Block p_424104_,
        ResourceLocation p_426550_,
        ResourceLocation p_425480_,
        ResourceLocation p_422907_,
        ResourceLocation p_423016_,
        ResourceLocation p_425357_,
        ResourceLocation p_431620_
    ) {
        MultiVariant multivariant = plainVariant(p_426550_);
        MultiVariant multivariant1 = plainVariant(p_425480_);
        MultiVariant multivariant2 = plainVariant(p_422907_);
        MultiVariant multivariant3 = plainVariant(p_423016_);
        MultiVariant multivariant4 = plainVariant(p_425357_);
        MultiVariant multivariant5 = plainVariant(p_431620_);
        this.blockStateOutput
            .accept(
    ...
    protected void createHead(Block p_376902_, Block p_378202_, SkullBlock.Type p_375856_, ResourceLocation p_377201_) {
        ...
        if (p_375856_ == SkullBlock.Types.PLAYER) {
            this.itemModelOutput.accept(p_376902_.asItem(), ItemModelUtils.specialModel(p_377201_, new PlayerHeadSpecialRenderer.Unbaked()));
        } else {
        ...
        this.itemModelOutput
            .accept(
                ...
                ItemModelUtils.selectBlockItemProperty(
                    ...
                    ItemModelUtils.specialModel(resourcelocation, new CopperGolemStatueSpecialRenderer.Unbaked(p_423400_, CopperGolemStatueBlock.Pose.STANDING)),
                    Map.of(
                        CopperGolemStatueBlock.Pose.SITTING,
                        ItemModelUtils.specialModel(resourcelocation, new CopperGolemStatueSpecialRenderer.Unbaked(p_423400_, CopperGolemStatueBlock.Pose.SITTING)),
                        CopperGolemStatueBlock.Pose.STAR,
                        ItemModelUtils.specialModel(resourcelocation, new CopperGolemStatueSpecialRenderer.Unbaked(p_423400_, CopperGolemStatueBlock.Pose.STAR)),
                        CopperGolemStatueBlock.Pose.RUNNING,
                        ItemModelUtils.specialModel(resourcelocation, new CopperGolemStatueSpecialRenderer.Unbaked(p_423400_, CopperGolemStatueBlock.Pose.RUNNING))
                    )
                )
            );
    }
    ...
    protected void createCopperChainItem(Item p_431380_, Item p_422705_) {
        ResourceLocation resourcelocation = this.createFlatItemModel(p_431380_);
        this.registerSimpleItemModel(p_431380_, resourcelocation);
        this.registerSimpleItemModel(p_422705_, resourcelocation);
    }
