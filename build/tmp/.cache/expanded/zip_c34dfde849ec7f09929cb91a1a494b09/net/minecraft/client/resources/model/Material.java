...
public class Material {
    ...
    public VertexConsumer buffer(MaterialSet p_428142_, MultiBufferSource p_119198_, Function<ResourceLocation, RenderType> p_119199_) {
        return p_428142_.get(this).wrap(p_119198_.getBuffer(this.renderType(p_119199_)));
    }

    public VertexConsumer buffer(
        MaterialSet p_429946_, MultiBufferSource p_119195_, Function<ResourceLocation, RenderType> p_119196_, boolean p_429743_, boolean p_426800_
    ) {
