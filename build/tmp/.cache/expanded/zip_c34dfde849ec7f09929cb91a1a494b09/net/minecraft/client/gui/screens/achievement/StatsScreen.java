        ...
        class HeaderEntry extends StatsScreen.ItemStatisticsList.Entry {
            ...
            public void renderContent(GuiGraphics p_427361_, int p_427610_, int p_424788_, boolean p_422515_, float p_431410_) {
                ...
                if (ItemStatisticsList.this.sortColumn != null) {
                    ...
                    p_427361_.blitSprite(RenderPipelines.GUI_TEXTURED, resourcelocation, this.getContentX() + i, this.getContentY() + 1, 18, 18);
                }
            }
            ...
            class StatSortButton extends ImageButton {
                ...
                StatSortButton(final int p_429613_, final ResourceLocation p_426840_) {
                    super(
                        18,
                        18,
                    ...
                    this.sprite = p_426840_;
                    this.setTooltip(Tooltip.create(this.getMessage()));
                }

                @Override
                public void renderWidget(GuiGraphics p_423164_, int p_424025_, int p_422301_, float p_431697_) {
                    ResourceLocation resourcelocation = this.sprites.get(this.isActive(), this.isHoveredOrFocused());
                    p_423164_.blitSprite(RenderPipelines.GUI_TEXTURED, resourcelocation, this.getX(), this.getY(), this.width, this.height);
                    p_423164_.blitSprite(RenderPipelines.GUI_TEXTURED, this.sprite, this.getX(), this.getY(), this.width, this.height);
                }
            }
        }
