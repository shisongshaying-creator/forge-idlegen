...
public class ModelBlockRenderer {
    ...
    private void renderModelFaceAO(
        ...
        for (BakedQuad bakedquad : p_111018_) {
            calculateShape(p_111013_, p_111014_, p_111015_, bakedquad.vertices(), bakedquad.direction(), p_397799_);
    ...
    private void putQuadData(
        ...
        p_111027_.putBulkData(p_111028_, p_111029_, p_391833_.brightness, f, f1, f2, 1.0F, p_391833_.lightmap, p_111034_, true);
    }
    ...
    private static void calculateShape(
        ...
        int[] p_111043_,
        Direction p_111044_,
        ModelBlockRenderer.CommonRenderStorage p_394767_
    ) {
        float f = 32.0F;
        float f1 = 32.0F;
        float f2 = 32.0F;
        ...
        p_394767_.facePartial = switch (p_111044_) {
        ...
        p_394767_.faceCubic = switch (p_111044_) {
    ...
    private void renderModelFaceFlat(
        ...
        for (BakedQuad bakedquad : p_111010_) {
            if (p_111007_) {
                calculateShape(p_111002_, p_111003_, p_111004_, bakedquad.vertices(), bakedquad.direction(), p_396196_);
