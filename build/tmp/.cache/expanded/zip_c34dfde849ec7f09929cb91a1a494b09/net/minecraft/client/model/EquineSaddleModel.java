...
public class EquineSaddleModel extends AbstractEquineModel<EquineRenderState> {
    ...
    public EquineSaddleModel(ModelPart p_394862_) {
        super(p_394862_);
    ...
    public static LayerDefinition createSaddleLayer(boolean p_393776_) {
        return createFullScaleSaddleLayer(p_393776_).apply(p_393776_ ? BABY_TRANSFORMER : MeshTransformer.IDENTITY);
    }

    public static LayerDefinition createFullScaleSaddleLayer(boolean p_395302_) {
        MeshDefinition meshdefinition = p_395302_ ? createFullScaleBabyMesh(CubeDeformation.NONE) : createBodyMesh(CubeDeformation.NONE);
    ...
    @Override
    public void setupAnim(EquineRenderState p_393718_) {
        super.setupAnim(p_393718_);

        for (ModelPart modelpart : this.ridingParts) {
            modelpart.visible = p_393718_.isRidden;
        }
    }
}