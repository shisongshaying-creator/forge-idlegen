...
public class PlayerCapeModel extends PlayerModel {
    ...
    @Override
    public void setupAnim(AvatarRenderState p_425212_) {
        super.setupAnim(p_425212_);
        this.cape
            .rotateBy(
                new Quaternionf()
                    .rotateY((float) -Math.PI)
                    .rotateX((6.0F + p_425212_.capeLean / 2.0F + p_425212_.capeFlap) * (float) (Math.PI / 180.0))
                    .rotateZ(p_425212_.capeLean2 / 2.0F * (float) (Math.PI / 180.0))
                    .rotateY((180.0F - p_425212_.capeLean2 / 2.0F) * (float) (Math.PI / 180.0))
            );
    }
}