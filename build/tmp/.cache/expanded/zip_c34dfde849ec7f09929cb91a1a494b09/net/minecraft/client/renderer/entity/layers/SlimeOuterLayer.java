    ...
    public void submit(PoseStack p_423939_, SubmitNodeCollector p_429066_, int p_425663_, SlimeRenderState p_430262_, float p_427382_, float p_429878_) {
        ...
        if (!p_430262_.isInvisible || flag) {
            ...
            if (flag) {
                p_429066_.order(1)
                    .submitModel(
                        this.model, p_430262_, p_423939_, RenderType.outline(SlimeRenderer.SLIME_LOCATION), p_425663_, i, -1, null, p_430262_.outlineColor, null
                    );
            } else {
                p_429066_.order(1)
                    .submitModel(
                        this.model, p_430262_, p_423939_, RenderType.entityTranslucent(SlimeRenderer.SLIME_LOCATION), p_425663_, i, -1, null, p_430262_.outlineColor, null
                    );
            }
        }
    }
