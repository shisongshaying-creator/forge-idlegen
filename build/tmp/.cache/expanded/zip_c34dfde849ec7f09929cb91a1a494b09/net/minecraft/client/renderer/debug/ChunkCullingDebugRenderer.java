...
public class ChunkCullingDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
    ...
    @Override
    public void render(
        PoseStack p_360717_, MultiBufferSource p_369170_, double p_361626_, double p_369161_, double p_367114_, DebugValueAccess p_428885_, Frustum p_428110_
    ) {
    ...
    private void addFrustumQuad(
        ...
        p_365841_.addVertex(p_367573_, p_369613_[p_360822_].x(), p_369613_[p_360822_].y(), p_369613_[p_360822_].z())
            .setColor(p_367084_, p_367738_, p_367810_, 0.25F);
