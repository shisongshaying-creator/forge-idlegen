...
public class Time extends NeedleDirectionHelper implements RangeSelectItemModelProperty {
    ...
    @Override
    protected float calculate(ItemStack p_378177_, ClientLevel p_378594_, int p_378007_, @Nullable ItemOwner p_424452_) {
    ...
    public static enum TimeSource implements StringRepresentable {
        RANDOM("random") {
            @Override
            public float get(@Nullable ClientLevel p_378410_, ItemStack p_375483_, @Nullable ItemOwner p_426428_, RandomSource p_376828_) {
                return p_376828_.nextFloat();
            }
        },
        DAYTIME("daytime") {
            @Override
            public float get(ClientLevel p_376912_, ItemStack p_377893_, @Nullable ItemOwner p_427146_, RandomSource p_375920_) {
                return p_376912_.getTimeOfDay(1.0F);
            }
        },
        MOON_PHASE("moon_phase") {
            @Override
            public float get(ClientLevel p_377401_, ItemStack p_376961_, @Nullable ItemOwner p_422855_, RandomSource p_377203_) {
                return p_377401_.getMoonPhase() / 8.0F;
            }
        };
        ...
        abstract float get(ClientLevel p_375860_, ItemStack p_378077_, @Nullable ItemOwner p_422321_, RandomSource p_377827_);
    }
}