...
public class BreezeModel extends EntityModel<BreezeRenderState> {
    ...
    public BreezeModel(ModelPart p_309507_) {
        ...
        this.idleAnimation = BreezeAnimation.IDLE.bake(p_309507_);
        this.shootAnimation = BreezeAnimation.SHOOT.bake(p_309507_);
        this.slideAnimation = BreezeAnimation.SLIDE.bake(p_309507_);
        this.slideBackAnimation = BreezeAnimation.SLIDE_BACK.bake(p_309507_);
        this.inhaleAnimation = BreezeAnimation.INHALE.bake(p_309507_);
        this.jumpAnimation = BreezeAnimation.JUMP.bake(p_309507_);
    }
    ...
    public void setupAnim(BreezeRenderState p_364657_) {
        ...
        this.idleAnimation.apply(p_364657_.idle, p_364657_.ageInTicks);
        this.shootAnimation.apply(p_364657_.shoot, p_364657_.ageInTicks);
        this.slideAnimation.apply(p_364657_.slide, p_364657_.ageInTicks);
        this.slideBackAnimation.apply(p_364657_.slideBack, p_364657_.ageInTicks);
        this.inhaleAnimation.apply(p_364657_.inhale, p_364657_.ageInTicks);
        this.jumpAnimation.apply(p_364657_.longJump, p_364657_.ageInTicks);
    }
