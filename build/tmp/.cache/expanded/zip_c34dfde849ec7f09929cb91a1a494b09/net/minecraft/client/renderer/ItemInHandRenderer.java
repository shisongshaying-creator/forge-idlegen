...
public class ItemInHandRenderer {
    ...
    private void renderMapHand(PoseStack p_109362_, SubmitNodeCollector p_427410_, int p_109364_, HumanoidArm p_109365_) {
        ...
        if (p_109365_ == HumanoidArm.RIGHT) {
            avatarrenderer.renderRightHand(p_109362_, p_427410_, p_109364_, resourcelocation, this.minecraft.player.isModelPartShown(PlayerModelPart.RIGHT_SLEEVE));
        } else {
            avatarrenderer.renderLeftHand(p_109362_, p_427410_, p_109364_, resourcelocation, this.minecraft.player.isModelPartShown(PlayerModelPart.LEFT_SLEEVE));
        }
    ...
    private void renderPlayerArm(PoseStack p_109347_, SubmitNodeCollector p_428322_, int p_109349_, float p_109350_, float p_109351_, HumanoidArm p_109352_) {
        ...
        if (flag) {
            avatarrenderer.renderRightHand(p_109347_, p_428322_, p_109349_, resourcelocation, abstractclientplayer.isModelPartShown(PlayerModelPart.RIGHT_SLEEVE));
        } else {
            avatarrenderer.renderLeftHand(p_109347_, p_428322_, p_109349_, resourcelocation, abstractclientplayer.isModelPartShown(PlayerModelPart.LEFT_SLEEVE));
        }
    }
    ...
    public void renderHandsWithItems(float p_109315_, PoseStack p_109316_, SubmitNodeCollector p_424174_, LocalPlayer p_109318_, int p_109319_) {
        ...
        if (iteminhandrenderer$handrenderselection.renderMainHand) {
            ...
            if (!net.minecraftforge.client.ForgeHooksClient.renderSpecificFirstPersonHand(InteractionHand.MAIN_HAND, p_109316_, p_424174_, p_109319_, p_109315_, f1, f4, f5, this.mainHandItem))
