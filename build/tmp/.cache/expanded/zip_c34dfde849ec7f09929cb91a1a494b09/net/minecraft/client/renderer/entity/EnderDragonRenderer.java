...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon, EnderDragonRenderState> {
    ...
    public void submit(EnderDragonRenderState p_430659_, PoseStack p_425524_, SubmitNodeCollector p_423449_, CameraRenderState p_424851_) {
        ...
        if (p_430659_.deathTime > 0.0F) {
            ...
            submitRays(p_425524_, f2, p_423449_, RenderType.dragonRays());
            submitRays(p_425524_, f2, p_423449_, RenderType.dragonRaysDepth());
            p_425524_.popPose();
        }
    ...
    public static void extractAdditionalHitboxexGeneric(net.minecraft.world.entity.Entity p_394570_, Builder<HitboxRenderState> p_396096_, float p_397646_) {
        if (!p_394570_.isMultipartEntity()) return;
        ...
        for (var enderdragonpart : p_394570_.getParts()) {
