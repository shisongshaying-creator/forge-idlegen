...
public class PlayerHeadSpecialRenderer implements SpecialModelRenderer<PlayerSkinRenderCache.RenderInfo> {
    ...
    PlayerHeadSpecialRenderer(PlayerSkinRenderCache p_429139_, SkullModelBase p_406150_) {
        this.playerSkinRenderCache = p_429139_;
        this.modelBase = p_406150_;
    }

    public void submit(
        @Nullable PlayerSkinRenderCache.RenderInfo p_431143_,
    ...
    @Nullable
    public PlayerSkinRenderCache.RenderInfo extractArgument(ItemStack p_407162_) {
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        ...
        @Nullable
        @Override
        public SpecialModelRenderer<?> bake(SpecialModelRenderer.BakingContext p_426480_) {
