...
public class GuiRenderer implements AutoCloseable {
    ...
    public GuiRenderer(
        ...
        net.minecraftforge.client.ForgeHooksClient.onRegisterPictureInPictureRenderers(p_410565_, p_410441_, builder);
    ...
    private void prepareText() {
        this.renderState.forEachText(p_409515_ -> {
            ...
            p_409515_.ensurePrepared().visit(new Font.GlyphVisitor() {
                @Override
                public void acceptGlyph(TextRenderable p_426658_) {
                    this.accept(p_426658_);
                }
                ...
                private void accept(TextRenderable p_423275_) {
                    GuiRenderer.this.renderState.submitGlyphToCurrentLayer(new GlyphRenderState(matrix3x2f, p_423275_, screenrectangle));
                }
            });
        });
    }
    ...
    private boolean scissorChanged(ScreenRectangle p_408511_, @Nullable ScreenRectangle p_408926_) {
