...
public class SkinTextureDownloader {
    ...
    public CompletableFuture<ClientAsset.Texture> downloadAndRegisterSkin(ResourceLocation p_375945_, Path p_376675_, String p_377957_, boolean p_377468_) {
        ClientAsset.DownloadedTexture clientasset$downloadedtexture = new ClientAsset.DownloadedTexture(p_375945_, p_377957_);
