...
public class SupportBlockRenderer implements DebugRenderer.SimpleDebugRenderer {
    ...
    @Override
    public void render(
        PoseStack p_286297_, MultiBufferSource p_286436_, double p_286291_, double p_286388_, double p_286330_, DebugValueAccess p_423631_, Frustum p_431127_
    ) {
    ...
    private void highlightPosition(
        ...
        ShapeRenderer.renderLineBox(p_286592_.last(), p_286314_.getBuffer(RenderType.lines()), d0, d1, d2, d3, d4, d5, p_286918_, p_286304_, p_286672_, 0.4F);
