...
public class CompassAngleState extends NeedleDirectionHelper {
    ...
    @Override
    protected float calculate(ItemStack p_376712_, ClientLevel p_377258_, int p_377034_, @Nullable ItemOwner p_425659_) {
    ...
    private static boolean isValidCompassTargetPos(@Nullable ItemOwner p_423243_, @Nullable GlobalPos p_376149_) {
    ...
    public static enum CompassTarget implements StringRepresentable {
        NONE("none") {
            @Nullable
            @Override
            public GlobalPos get(ClientLevel p_375914_, ItemStack p_376028_, @Nullable ItemOwner p_423750_) {
                return null;
            }
        },
        LODESTONE("lodestone") {
            @Nullable
            @Override
            public GlobalPos get(ClientLevel p_376563_, ItemStack p_377548_, @Nullable ItemOwner p_423946_) {
        ...
        RECOVERY("recovery") {
            @Nullable
            @Override
            public GlobalPos get(ClientLevel p_375618_, ItemStack p_378046_, @Nullable ItemOwner p_425437_) {
        ...
        @Nullable
        abstract GlobalPos get(ClientLevel p_375459_, ItemStack p_375402_, @Nullable ItemOwner p_428349_);
    }
}