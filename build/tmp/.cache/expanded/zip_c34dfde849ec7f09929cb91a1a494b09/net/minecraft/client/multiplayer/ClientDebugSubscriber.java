...
public class ClientDebugSubscriber {
    ...
    private void onSubscriptionsChanged(Set<DebugSubscription<?>> p_427165_) {
        ...
        for (DebugSubscription<?> debugsubscription : p_427165_) {
    ...
    @Nullable
    <V> ClientDebugSubscriber.ValueMaps<V> getValueMaps(DebugSubscription<V> p_422955_) {
        return (ClientDebugSubscriber.ValueMaps<V>)this.valuesBySubscription.get(p_422955_);
    }

    @Nullable
    private <K, V> ClientDebugSubscriber.ValueMap<K, V> getValueMap(DebugSubscription<V> p_424377_, ClientDebugSubscriber.ValueMapType<K, V> p_423384_) {
    ...
    @Nullable
    <K, V> V getValue(DebugSubscription<V> p_426326_, K p_423774_, ClientDebugSubscriber.ValueMapType<K, V> p_422304_) {
    ...
    public DebugValueAccess createDebugValueAccess(final Level p_430673_) {
        return new DebugValueAccess() {
            ...
            @Nullable
            @Override
            public <T> T getChunkValue(DebugSubscription<T> p_427123_, ChunkPos p_430839_) {
            ...
            @Nullable
            @Override
            public <T> T getBlockValue(DebugSubscription<T> p_424544_, BlockPos p_430316_) {
            ...
            @Nullable
            @Override
            public <T> T getEntityValue(DebugSubscription<T> p_428389_, Entity p_427831_) {
