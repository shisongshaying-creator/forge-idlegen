...
public class LavaFogEnvironment extends FogEnvironment {
    ...
    @Override
    public void setupFog(FogData p_406361_, Entity p_406301_, BlockPos p_409904_, ClientLevel p_409030_, float p_410074_, DeltaTracker p_406706_) {
        if (p_406301_.isSpectator()) {
            p_406361_.environmentalStart = -8.0F;
            p_406361_.environmentalEnd = p_410074_ * 0.5F;
        } else if (p_406301_ instanceof LivingEntity livingentity && livingentity.hasEffect(MobEffects.FIRE_RESISTANCE)) {
