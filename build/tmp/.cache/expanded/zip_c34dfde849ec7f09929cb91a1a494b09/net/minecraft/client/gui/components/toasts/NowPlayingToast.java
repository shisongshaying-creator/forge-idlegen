...
public class NowPlayingToast implements Toast {
    ...
    public static void renderToast(GuiGraphics p_410666_, Font p_408972_) {
        if (currentSong != null) {
            p_410666_.blitSprite(RenderPipelines.GUI_TEXTURED, NOW_PLAYING_BACKGROUND_SPRITE, 0, 0, getWidth(currentSong, p_408972_), 30);
            int i = 7;
            p_410666_.blitSprite(RenderPipelines.GUI_TEXTURED, MUSIC_NOTES_SPRITE, 7, 7, 16, 16, musicNoteColor);
            p_410666_.drawString(p_408972_, getNowPlayingString(currentSong), 30, 15 - 9 / 2, TEXT_COLOR);
        }
    }
