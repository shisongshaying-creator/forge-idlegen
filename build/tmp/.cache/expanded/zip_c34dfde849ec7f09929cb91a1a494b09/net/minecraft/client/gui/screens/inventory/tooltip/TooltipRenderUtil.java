...
public class TooltipRenderUtil {
    ...
    public static void renderTooltipBackground(GuiGraphics p_282666_, int p_281901_, int p_281846_, int p_281559_, int p_283336_, @Nullable ResourceLocation p_367789_) {
        int i = p_281901_ - 3 - 9;
        int j = p_281846_ - 3 - 9;
        int k = p_281559_ + 3 + 3 + 18;
        int l = p_283336_ + 3 + 3 + 18;
        p_282666_.blitSprite(RenderPipelines.GUI_TEXTURED, getBackgroundSprite(p_367789_), i, j, k, l);
        p_282666_.blitSprite(RenderPipelines.GUI_TEXTURED, getFrameSprite(p_367789_), i, j, k, l);
    }
