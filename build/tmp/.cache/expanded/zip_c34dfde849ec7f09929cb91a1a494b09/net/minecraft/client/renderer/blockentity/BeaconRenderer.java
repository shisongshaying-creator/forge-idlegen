...
public class BeaconRenderer<T extends BlockEntity & BeaconBeamOwner> implements BlockEntityRenderer<T, BeaconRenderState> {
    ...
    public void extractRenderState(T p_431678_, BeaconRenderState p_429388_, float p_429147_, Vec3 p_430767_, @Nullable ModelFeatureRenderer.CrumblingOverlay p_425159_) {
    ...
    public static void submitBeaconBeam(
        ...
        p_423842_.submitCustomGeometry(
            p_430215_,
            RenderType.beaconBeam(p_431585_, false),
        ...
        p_423842_.submitCustomGeometry(
            p_430215_,
            RenderType.beaconBeam(p_431585_, true),
