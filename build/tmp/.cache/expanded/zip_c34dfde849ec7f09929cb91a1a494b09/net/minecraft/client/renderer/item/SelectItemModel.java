            ...
            if (p_394419_ == null) {
                ...
                CacheSlot<ClientLevel, Object2ObjectMap<T, ItemModel>> cacheslot = new CacheSlot<>(
                    p_389553_ -> {
                        ...
                        p_393306_.forEach(
                            (p_421029_, p_421030_) -> p_394419_.swapTo(this.property.valueCodec(), (T)p_421029_, p_389553_.registryAccess())
                                .ifSuccess(p_389544_ -> object2objectmap.put((T)p_389544_, p_421030_))
                        );
