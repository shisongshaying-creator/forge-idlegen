...
public record ScreenRectangle(ScreenPosition position, int width, int height) {
    ...
    public ScreenRectangle transformAxisAligned(Matrix3x2f p_408275_) {
        Vector2f vector2f = p_408275_.transformPosition(this.left(), this.top(), new Vector2f());
        Vector2f vector2f1 = p_408275_.transformPosition(this.right(), this.bottom(), new Vector2f());
        return new ScreenRectangle(
            Mth.floor(vector2f.x), Mth.floor(vector2f.y), Mth.floor(vector2f1.x - vector2f.x), Mth.floor(vector2f1.y - vector2f.y)
        );
    }

    public ScreenRectangle transformMaxBounds(Matrix3x2f p_409845_) {
        Vector2f vector2f = p_409845_.transformPosition(this.left(), this.top(), new Vector2f());
        Vector2f vector2f1 = p_409845_.transformPosition(this.right(), this.top(), new Vector2f());
        Vector2f vector2f2 = p_409845_.transformPosition(this.left(), this.bottom(), new Vector2f());
        Vector2f vector2f3 = p_409845_.transformPosition(this.right(), this.bottom(), new Vector2f());
