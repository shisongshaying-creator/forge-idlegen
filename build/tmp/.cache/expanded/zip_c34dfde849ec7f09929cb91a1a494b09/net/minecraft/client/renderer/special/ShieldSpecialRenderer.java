...
public class ShieldSpecialRenderer implements SpecialModelRenderer<DataComponentMap> {
    ...
    public ShieldSpecialRenderer(MaterialSet p_424916_, ShieldModel p_375550_) {
    ...
    @Override
    public void getExtents(Set<Vector3f> p_408746_) {
        PoseStack posestack = new PoseStack();
        posestack.scale(1.0F, -1.0F, -1.0F);
        this.model.root().getExtentsForGui(posestack, p_408746_);
    }
