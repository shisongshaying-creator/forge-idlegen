...
public class OctreeDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
    ...
    @Override
    public void render(
        PoseStack p_368352_, MultiBufferSource p_363548_, double p_363763_, double p_367605_, double p_361347_, DebugValueAccess p_426568_, Frustum p_366121_
    ) {
    ...
    private void renderNode(
        ...
        ShapeRenderer.renderLineBox(
            p_361623_.last(),
            vertexconsumer,
            aabb.deflate(0.1 * p_362077_).move(-p_368967_, -p_363341_, -p_365959_),
