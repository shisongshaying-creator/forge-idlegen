...
public class InputControlHandlers {
    ...
    @Nullable
    private static <T extends InputControl> InputControlHandler<T> get(T p_406934_) {
    ...
    static class SingleOptionHandler implements InputControlHandler<SingleOptionInput> {
        public void addControl(SingleOptionInput p_407094_, Screen p_406176_, InputControlHandler.Output p_410623_) {
            CycleButton.Builder<SingleOptionInput.Entry> builder = CycleButton.builder(SingleOptionInput.Entry::displayOrDefault)
                ...
                .displayOnlyValue(!p_407094_.labelVisible());
            Optional<SingleOptionInput.Entry> optional = p_407094_.initial();
