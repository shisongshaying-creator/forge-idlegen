...
public class SimpleSoundInstance extends AbstractSoundInstance {
    ...
    public static SimpleSoundInstance forMusic(SoundEvent p_119746_, float p_408799_) {
        return new SimpleSoundInstance(
            p_119746_.location(), SoundSource.MUSIC, p_408799_, 1.0F, SoundInstance.createUnseededRandom(), false, 0, SoundInstance.Attenuation.NONE, 0.0, 0.0, 0.0, true
        );
    }
