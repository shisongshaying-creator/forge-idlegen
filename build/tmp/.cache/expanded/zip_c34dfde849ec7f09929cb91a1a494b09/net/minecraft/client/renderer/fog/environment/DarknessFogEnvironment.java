...
public class DarknessFogEnvironment extends MobEffectFogEnvironment {
    ...
    @Override
    public void setupFog(FogData p_408959_, Entity p_405960_, BlockPos p_410423_, ClientLevel p_409046_, float p_409573_, DeltaTracker p_408552_) {
        if (p_405960_ instanceof LivingEntity livingentity) {
