...
public class WardenRenderer extends MobRenderer<Warden, WardenRenderState, WardenModel> {
    ...
    public WardenRenderer(EntityRendererProvider.Context p_234787_) {
        ...
        this.addLayer(new LivingEntityEmissiveLayer<>(this, p_421021_ -> BIOLUMINESCENT_LAYER_TEXTURE, (p_361019_, p_234810_) -> 1.0F, wardenmodel, RenderType::entityTranslucentEmissive, false));
        this.addLayer(
            new LivingEntityEmissiveLayer<>(
                this,
                p_421025_ -> PULSATING_SPOTS_TEXTURE_1,
        ...
        this.addLayer(
            new LivingEntityEmissiveLayer<>(
                this,
                p_421023_ -> PULSATING_SPOTS_TEXTURE_2,
        ...
        this.addLayer(
            new LivingEntityEmissiveLayer<>(
                this, p_421024_ -> TEXTURE, (p_358002_, p_358003_) -> p_358002_.tendrilAnimation, wardenmodel2, RenderType::entityTranslucentEmissive, false
            )
        );
        this.addLayer(
            new LivingEntityEmissiveLayer<>(
                this, p_421022_ -> HEART_TEXTURE, (p_358004_, p_358005_) -> p_358004_.heartAnimation, wardenmodel3, RenderType::entityTranslucentEmissive, false
            )
        );
    }
