...
public class PowderedSnowFogEnvironment extends FogEnvironment {
    ...
    @Override
    public void setupFog(FogData p_406185_, Entity p_408816_, BlockPos p_410050_, ClientLevel p_406285_, float p_409283_, DeltaTracker p_409577_) {
        if (p_408816_.isSpectator()) {
