...
public class CamelSaddleModel extends CamelModel {
    ...
    public CamelSaddleModel(ModelPart p_393315_) {
        super(p_393315_);
    }
    ...
    @Override
    public void setupAnim(CamelRenderState p_396513_) {
        super.setupAnim(p_396513_);
        this.reins.visible = p_396513_.isRidden;
    }
}