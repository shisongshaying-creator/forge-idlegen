...
public class LightSectionDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
    ...
    @Override
    public void render(
        PoseStack p_281418_, MultiBufferSource p_282487_, double p_282164_, double p_282565_, double p_281615_, DebugValueAccess p_422784_, Frustum p_429988_
    ) {
    ...
    private static void renderFace(
        ...
        float f = (float)(SectionPos.sectionToBlockCoord(p_282751_) - p_281988_);
        float f1 = (float)(SectionPos.sectionToBlockCoord(p_282270_) - p_282440_);
        float f2 = (float)(SectionPos.sectionToBlockCoord(p_282159_) - p_282235_);
    ...
    private static void renderEdge(
        ...
        float f = (float)(SectionPos.sectionToBlockCoord(p_281439_) - p_283424_);
        float f1 = (float)(SectionPos.sectionToBlockCoord(p_282106_) - p_283677_);
        float f2 = (float)(SectionPos.sectionToBlockCoord(p_282462_) - p_283390_);
        float f3 = (float)(SectionPos.sectionToBlockCoord(p_282216_) - p_283424_);
        float f4 = (float)(SectionPos.sectionToBlockCoord(p_281474_) - p_283677_);
        float f5 = (float)(SectionPos.sectionToBlockCoord(p_281542_) - p_283390_);
