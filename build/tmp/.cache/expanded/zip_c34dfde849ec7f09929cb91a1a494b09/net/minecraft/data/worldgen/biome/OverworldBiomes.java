...
public class OverworldBiomes {
    ...
    private static Biome biome(
        ...
        return biome(p_265746_, p_265800_, p_265276_, 4159204, 329011, null, null, null, p_265425_, p_265371_, p_265636_);
    }
    ...
    private static Biome biome(
        ...
        if (p_395961_ != null) {
            biomespecialeffects$builder.dryFoliageColorOverride(p_395961_);
        }
    ...
    private static Biome baseOcean(MobSpawnSettings.Builder p_194872_, int p_194873_, int p_194874_, BiomeGenerationSettings.Builder p_194875_) {
        return biome(true, 0.5F, 0.5F, p_194873_, p_194874_, null, null, null, p_194872_, p_194875_, NORMAL_MUSIC);
    }
    ...
    public static Biome river(HolderGetter<PlacedFeature> p_256613_, HolderGetter<ConfiguredWorldCarver<?>> p_256581_, boolean p_194915_) {
        ...
        return biome(
            true, f, 0.5F, p_194915_ ? 3750089 : 4159204, 329011, null, null, null, mobspawnsettings$builder, biomegenerationsettings$builder, NORMAL_MUSIC
        );
    }
