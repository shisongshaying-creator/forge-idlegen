...
public class VanillaRecipeProvider extends RecipeProvider {
    ...
    protected VanillaRecipeProvider(HolderLookup.Provider p_362726_, RecipeOutput p_362384_) {
    ...
    public static Stream<VanillaRecipeProvider.TrimTemplate> smithingTrims() {
        return Stream.of(
            ...
            .map(p_405063_ -> {
                Item item = (Item)p_405063_.getFirst();
                ResourceKey<TrimPattern> resourcekey = (ResourceKey<TrimPattern>)p_405063_.getSecond();
                ResourceKey<Recipe<?>> resourcekey1 = ResourceKey.create(
                    Registries.RECIPE, ResourceLocation.withDefaultNamespace(getItemName(item) + "_smithing_trim")
                );
