...
public class JsonRpcNotificationService implements NotificationService {
    ...
    @Override
    public void onGameRuleChanged(String p_429464_, GameRules.Value<?> p_423767_) {
        this.broadcastNotification(OutgoingRpcMethods.GAMERULE_CHANGED, GameRulesService.getTypedRule(this.minecraftApi, p_429464_, p_423767_));
    }
