                                            ...
                                            Commands.argument("respectTeams", BoolArgumentType.bool())
                                                .then(
                                                    Commands.argument("targets", EntityArgument.entities())
                                                        .executes(
                                                            p_421370_ -> spreadPlayers(
                                                                p_421370_.getSource(),
                                                                Vec2Argument.getVec2(p_421370_, "center"),
                                                                FloatArgumentType.getFloat(p_421370_, "spreadDistance"),
                                                                FloatArgumentType.getFloat(p_421370_, "maxRange"),
                                                                p_421370_.getSource().getLevel().getMaxY() + 1,
                                                                BoolArgumentType.getBool(p_421370_, "respectTeams"),
                                                                EntityArgument.getEntities(p_421370_, "targets")
                                                            )
                                                        )
                                                )
                                        )
