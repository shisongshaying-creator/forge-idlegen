...
public class MinecraftOperatorListServiceImpl implements MinecraftOperatorListService {
    ...
    @Override
    public void op(NameAndId p_424857_, Optional<Integer> p_423949_, Optional<Boolean> p_422334_, ClientInfo p_425067_) {
        this.jsonrpcLogger.log(p_425067_, "Op '{}'", p_424857_);
        this.minecraftServer.getPlayerList().op(p_424857_, p_423949_, p_422334_);
    }
