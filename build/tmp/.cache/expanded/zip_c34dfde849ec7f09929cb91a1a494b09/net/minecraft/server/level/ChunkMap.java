...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider, GeneratingChunkMap {
    ...
    @Nullable
    public ChunkStatus getLatestStatus(long p_422359_) {
    ...
    private CompletableFuture<ChunkAccess> scheduleChunkLoad(ChunkPos p_140418_) {
        CompletableFuture<Optional<SerializableChunkData>> completablefuture = this.readChunk(p_140418_)
            .thenApplyAsync(p_358681_ -> p_358681_.map(p_421445_ -> {
                SerializableChunkData serializablechunkdata = SerializableChunkData.parse(this.level, this.level.palettedContainerFactory(), p_421445_);
        ...
        return completablefuture.<Object, Optional<SerializableChunkData>>thenCombine(
            ...
            .thenApplyAsync(p_421440_ -> {
                Profiler.get().incrementCounter("chunkLoad");
                if (p_421440_.isPresent()) {
                    ChunkAccess chunkaccess = p_421440_.get().read(this.level, this.poiManager, this.storageInfo(), p_140418_);
    ...
    private boolean save(ChunkAccess p_140259_) {
        ...
        if (!p_140259_.tryMarkSaved()) {
            ...
            try {
                ...
                this.write(chunkpos, completablefuture::join).handle((p_421447_, p_421448_) -> {
                    if (p_421448_ != null) {
                        this.level.getServer().reportChunkSaveFailure(p_421448_, this.storageInfo(), chunkpos);
                    }
