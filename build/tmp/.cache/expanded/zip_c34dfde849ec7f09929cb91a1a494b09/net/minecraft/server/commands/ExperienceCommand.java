...
public class ExperienceCommand {
    ...
    static enum Type {
        POINTS("points", Player::giveExperiencePoints, (p_421319_, p_421320_) -> {
            if (p_421320_ >= p_421319_.getXpNeededForNextLevel()) {
                return false;
            } else {
                p_421319_.setExperiencePoints(p_421320_);
                return true;
            }
        }, p_421318_ -> Mth.floor(p_421318_.experienceProgress * p_421318_.getXpNeededForNextLevel())),
