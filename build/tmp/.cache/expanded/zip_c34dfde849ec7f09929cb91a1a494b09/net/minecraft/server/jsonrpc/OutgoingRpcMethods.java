...
public class OutgoingRpcMethods {
    ...
    public static final Holder.Reference<OutgoingRpcMethod.Notification<PlayerDto>> PLAYER_ADDED_TO_ALLOWLIST = OutgoingRpcMethod.notification(PlayerDto.CODEC.codec())
        .param(new ParamInfo("player", Schema.PLAYER_SCHEMA.asRef()))
        .description("Player was added to allowlist")
        .register("allowlist/added");
    public static final Holder.Reference<OutgoingRpcMethod.Notification<PlayerDto>> PLAYER_REMOVED_FROM_ALLOWLIST = OutgoingRpcMethod.notification(PlayerDto.CODEC.codec())
        .param(new ParamInfo("player", Schema.PLAYER_SCHEMA.asRef()))
