...
public class MinecraftServerSettingsServiceImpl implements MinecraftServerSettingsService {
    ...
    @Override
    public int setOperatorUserPermissionLevel(int p_426617_, ClientInfo p_423247_) {
        this.jsonrpcLogger.log(p_423247_, "Update operator user permission level from {} to {}", this.getOperatorUserPermissionLevel(), p_426617_);
        this.server.setOperatorUserPermissionLevel(p_426617_);
