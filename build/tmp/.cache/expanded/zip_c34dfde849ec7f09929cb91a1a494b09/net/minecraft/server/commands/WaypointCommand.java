    ...
    private static int setWaypointColor(CommandSourceStack p_407798_, WaypointTransmitter p_407282_, Integer p_410204_) {
        ...
        p_407798_.sendSuccess(
            () -> Component.translatable(
                "commands.waypoint.modify.color", Component.literal(String.format("%06X", ARGB.color(0, p_410204_))).withColor(p_410204_)
            ),
            false
        );
        return 0;
        ...
        if (set.isEmpty()) {
            ...
            Component component = ComponentUtils.formatList(
                set.stream()
                    .map(
                        p_421385_ -> {
                            if (p_421385_ instanceof LivingEntity livingentity) {
                                ...
                                return livingentity.getFeedbackDisplayName()
                                    ...
                                    .withStyle(
                                        p_406446_ -> p_406446_.withClickEvent(
                                            ...
                                            .withColor(p_421385_.waypointIcon().color.orElse(-1))
                                    );
                            } else {
                                return Component.literal(p_421385_.toString());
                            }
                        }
                    )
                    .toList(),
