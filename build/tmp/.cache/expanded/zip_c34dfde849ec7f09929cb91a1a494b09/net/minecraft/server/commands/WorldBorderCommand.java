                                ...
                                .then(
                                    Commands.argument("time", IntegerArgumentType.integer(0))
                                        .executes(
                                            p_421392_ -> setSize(
                                                p_421392_.getSource(),
                                                p_421392_.getSource().getLevel().getWorldBorder().getSize() + DoubleArgumentType.getDouble(p_421392_, "distance"),
                                                p_421392_.getSource().getLevel().getWorldBorder().getLerpTime()
                                                    + IntegerArgumentType.getInteger(p_421392_, "time") * 1000L
                                            )
                                        )
                                )
                        )
