...
public class DifficultyCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> p_136939_) {
        ...
        p_136939_.register(literalargumentbuilder.requires(Commands.hasPermission(2)).executes(p_421308_ -> {
            Difficulty difficulty1 = p_421308_.getSource().getLevel().getDifficulty();
            p_421308_.getSource().sendSuccess(() -> Component.translatable("commands.difficulty.query", difficulty1.getDisplayName()), false);
