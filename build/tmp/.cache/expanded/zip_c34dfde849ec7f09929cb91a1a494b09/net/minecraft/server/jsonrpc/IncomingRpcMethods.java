...
public class IncomingRpcMethods {
    public static IncomingRpcMethod bootstrap(Registry<IncomingRpcMethod> p_429047_) {
        ...
        return IncomingRpcMethod.<DiscoveryService.DiscoverResponse>method(
                p_423947_ -> DiscoveryService.discover(Schema.getSchemaRegistry()), DiscoveryService.DiscoverResponse.CODEC.codec()
            )
            .undiscoverable()
            .notOnMainThread()
    ...
    private static void registerBanlistService(Registry<IncomingRpcMethod> p_425539_) {
        ...
        IncomingRpcMethod.method(
                BanlistService::set, BanlistService.UserBanDto.CODEC.codec().listOf(), BanlistService.UserBanDto.CODEC.codec().listOf()
            )
        ...
        IncomingRpcMethod.method(
                BanlistService::add, BanlistService.UserBanDto.CODEC.codec().listOf(), BanlistService.UserBanDto.CODEC.codec().listOf()
            )
    ...
    private static void registerIpBanlistService(Registry<IncomingRpcMethod> p_429036_) {
        ...
        IncomingRpcMethod.method(
                IpBanlistService::set, IpBanlistService.IpBanDto.CODEC.codec().listOf(), IpBanlistService.IpBanDto.CODEC.codec().listOf()
            )
    ...
    private static void registerOperatorService(Registry<IncomingRpcMethod> p_425870_) {
        ...
        IncomingRpcMethod.method(
                OperatorService::set, OperatorService.OperatorDto.CODEC.codec().listOf(), OperatorService.OperatorDto.CODEC.codec().listOf()
            )
        ...
        IncomingRpcMethod.method(
                OperatorService::add, OperatorService.OperatorDto.CODEC.codec().listOf(), OperatorService.OperatorDto.CODEC.codec().listOf()
            )
