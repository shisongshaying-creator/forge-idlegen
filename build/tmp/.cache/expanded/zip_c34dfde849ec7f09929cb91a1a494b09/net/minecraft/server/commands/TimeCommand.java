                    ...
                    Commands.literal("query")
                        ...
                        .then(
                            Commands.literal("gametime")
                                .executes(p_421375_ -> queryTime(p_421375_.getSource(), (int)(p_421375_.getSource().getLevel().getGameTime() % 2147483647L)))
                        )
                        .then(
                            Commands.literal("day")
                                .executes(
                                    p_421374_ -> queryTime(p_421374_.getSource(), (int)(p_421374_.getSource().getLevel().getDayTime() / 24000L % 2147483647L))
                                )
                        )
                )
        );
