        ...
        this.goalSelector
            .addGoal(
                ...
                new UseItemGoal<>(
                    ...
                    p_421903_ -> this.level().isDarkOutside() && !p_421903_.isInvisible()
                )
            );
        this.goalSelector
            .addGoal(
                0, new UseItemGoal<>(this, new ItemStack(Items.MILK_BUCKET), SoundEvents.WANDERING_TRADER_REAPPEARED, p_421902_ -> this.level().isBrightOutside() && p_421902_.isInvisible())
            );
