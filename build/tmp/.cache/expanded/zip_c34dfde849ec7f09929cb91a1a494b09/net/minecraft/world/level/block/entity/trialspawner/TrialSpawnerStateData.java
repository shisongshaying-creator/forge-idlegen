...
public class TrialSpawnerStateData {
        ...
        if (!flag) {
            if (!p_408296_.getState().equals(TrialSpawnerState.COOLDOWN) || !p_408296_.isOminous()) {
                ...
                if (!p_408296_.isOminous() && !list.isEmpty()) {
                    ...
                    optional.ifPresent(p_422192_ -> {
                        Player player = p_422192_.getFirst();
                        if (p_422192_.getSecond() == MobEffects.BAD_OMEN) {
    ...
    @Nullable
    public Entity getOrCreateDisplayEntity(TrialSpawner p_407095_, Level p_410216_, TrialSpawnerState p_406028_) {
        if (!p_406028_.hasSpinningMob()) {
            ...
            if (this.displayEntity == null) {
                ...
                if (compoundtag.getString("id").isPresent()) {
                    this.displayEntity = EntityType.loadEntityRecursive(compoundtag, p_410216_, EntitySpawnReason.TRIAL_SPAWNER, Function.identity());
                }
            }
