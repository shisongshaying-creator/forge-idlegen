        ...
        this.targetSelector
            .addGoal(
                ...
                new NearestAttackableTargetGoal<>(
                    this, Player.class, 10, true, false, (p_421861_, p_421862_) -> Math.abs(p_421861_.getY() - this.getY()) <= 4.0
                )
            );
    ...
    public void remove(Entity.RemovalReason p_149847_) {
        ...
        if (!this.level().isClientSide() && i > 1 && this.isDeadOrDying()) {
            ...
            for (int l = 0; l < k; l++) {
                ...
                this.convertTo(
                    this.getType(), new ConversionParams(ConversionType.SPLIT_ON_DEATH, false, false, playerteam), EntitySpawnReason.TRIGGERED, p_421866_ -> {
                        p_421866_.setSize(j, true);
                        p_421866_.snapTo(this.getX() + f2, this.getY() + 0.5, this.getZ() + f3, this.random.nextFloat() * 360.0F, 0.0F);
                    }
                );
            }
        }
