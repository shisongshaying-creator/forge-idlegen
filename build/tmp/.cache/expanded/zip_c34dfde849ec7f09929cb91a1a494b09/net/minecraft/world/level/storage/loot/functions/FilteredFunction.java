...
public class FilteredFunction extends LootItemConditionalFunction {
    ...
    public FilteredFunction(List<LootItemCondition> p_333409_, ItemPredicate p_333352_, LootItemFunction p_328232_) {
        super(p_333409_);
    ...
    public void validate(ValidationContext p_336040_) {
        ...
        this.modifier.validate(p_336040_.forChild(new ProblemReporter.FieldPathElement("modifier")));
    }
}