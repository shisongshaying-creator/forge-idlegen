...
public class GoatAi {
    ...
    private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat()
        .selector(
            (p_421825_, p_421826_) -> !p_421825_.getType().equals(EntityType.GOAT)
                && (p_421826_.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) || !p_421825_.getType().equals(EntityType.ARMOR_STAND))
                && p_421826_.getWorldBorder().isWithinBounds(p_421825_.getBoundingBox())
        );
