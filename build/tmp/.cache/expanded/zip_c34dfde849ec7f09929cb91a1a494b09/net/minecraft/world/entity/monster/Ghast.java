...
public class Ghast extends Mob implements Enemy {
        ...
        this.targetSelector
            .addGoal(
                ...
                new NearestAttackableTargetGoal<>(
                    this, Player.class, 10, true, false, (p_421850_, p_421851_) -> Math.abs(p_421850_.getY() - this.getY()) <= 4.0
                )
            );
    }
    ...
    public static class GhastMoveControl extends MoveControl {
        ...
        private boolean canReach(Vec3 p_32771_) {
            ...
            return BlockGetter.forEachBlockIntersectedBetween(
                ...
                vec31,
                aabb1,
                (p_421857_, p_421858_) -> aabb.intersects(p_421857_) ? true : this.blockTraversalPossible(this.ghast.level(), vec3, vec31, p_421857_, flag, flag1)
            );
        }
    ...
    public static class RandomFloatAroundGoal extends Goal {
        ...
        @Nullable
        private static Vec3 chooseRandomPositionWithRestriction(Mob p_410298_, Vec3 p_408608_, RandomSource p_406675_) {
