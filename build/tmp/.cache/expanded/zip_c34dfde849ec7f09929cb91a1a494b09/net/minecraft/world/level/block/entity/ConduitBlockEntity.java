...
public class ConduitBlockEntity extends BlockEntity {
    ...
    @Nullable
    private static EntityReference<LivingEntity> selectNewTarget(ServerLevel p_406173_, BlockPos p_409120_) {
        List<LivingEntity> list = p_406173_.getEntitiesOfClass(LivingEntity.class, getDestroyRangeAABB(p_409120_), p_422156_ -> p_422156_ instanceof Enemy && p_422156_.isInWaterOrRain());
