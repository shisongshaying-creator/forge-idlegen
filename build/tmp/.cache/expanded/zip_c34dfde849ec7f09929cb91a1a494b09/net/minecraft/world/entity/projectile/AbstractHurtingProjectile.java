...
public abstract class AbstractHurtingProjectile extends Projectile {
    ...
    public AbstractHurtingProjectile(
        ...
        this.snapTo(p_36818_, p_36819_, p_36820_, this.getYRot(), this.getXRot());
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_409323_) {
        super.addAdditionalSaveData(p_409323_);
        p_409323_.putDouble("acceleration_power", this.accelerationPower);
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_410196_) {
        super.readAdditionalSaveData(p_410196_);
        this.accelerationPower = p_410196_.getDoubleOr("acceleration_power", 0.1);
    }
    ...
    @Override
    protected void onDeflection(boolean p_331188_) {
        super.onDeflection(p_331188_);
        if (p_331188_) {
