...
public abstract class AbstractFish extends WaterAnimal implements Bucketable {
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_407698_) {
        super.addAdditionalSaveData(p_407698_);
        p_407698_.putBoolean("FromBucket", this.fromBucket());
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_407259_) {
        super.readAdditionalSaveData(p_407259_);
        this.setFromBucket(p_407259_.getBooleanOr("FromBucket", false));
    }
