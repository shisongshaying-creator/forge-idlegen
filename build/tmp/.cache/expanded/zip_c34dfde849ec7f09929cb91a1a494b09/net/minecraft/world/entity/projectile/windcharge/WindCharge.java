...
public class WindCharge extends AbstractWindCharge {
    ...
    @Override
    public boolean deflect(ProjectileDeflection p_342982_, @Nullable Entity p_343086_, @Nullable EntityReference<Entity> p_423817_, boolean p_342935_) {
        return this.noDeflectTicks > 0 ? false : super.deflect(p_342982_, p_343086_, p_423817_, p_342935_);
    }
    ...
    public boolean shouldRenderAtSqrDistance(double p_365272_) {
        return this.tickCount < 2 && p_365272_ < MIN_CAMERA_DISTANCE_SQUARED ? false : super.shouldRenderAtSqrDistance(p_365272_);
    }
}