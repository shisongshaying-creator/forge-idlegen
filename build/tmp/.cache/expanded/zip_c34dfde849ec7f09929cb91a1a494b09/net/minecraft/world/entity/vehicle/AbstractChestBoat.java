...
public abstract class AbstractChestBoat extends AbstractBoat implements HasCustomInventoryScreen, ContainerEntity {
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_406093_) {
        super.addAdditionalSaveData(p_406093_);
        this.addChestVehicleSaveData(p_406093_);
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_407264_) {
        super.readAdditionalSaveData(p_407264_);
        this.readChestVehicleSaveData(p_407264_);
    }
    ...
    public InteractionResult interact(Player p_363142_, InteractionHand p_369395_) {
        ...
        } else if (this.canAddPassenger(p_363142_) && !p_363142_.isSecondaryUseActive()) {
    ...
    @Override
    public void stopOpen(ContainerUser p_425643_) {
        this.level().gameEvent(GameEvent.CONTAINER_CLOSE, this.position(), GameEvent.Context.of(p_425643_.getLivingEntity()));
    }
}