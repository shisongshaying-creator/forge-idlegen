    ...
    public static OneShot<LivingEntity> create(int p_259202_, float p_259881_, int p_259982_) {
        return BehaviorBuilder.create(
            p_258505_ -> p_258505_.group(
                ...
                .apply(
                    p_258505_,
                    (p_258484_, p_258485_, p_258486_, p_258487_, p_258488_, p_258489_, p_258490_) -> (p_421673_, p_421674_, p_421675_) -> {
                        p_421673_.getPoiManager()
                            .find(
                                p_217258_ -> p_217258_.is(PoiTypes.HOME),
                                p_23425_ -> true,
                                p_421674_.blockPosition(),
                                p_259982_ + 1,
                                PoiManager.Occupancy.ANY
                            )
                            .filter(p_421647_ -> p_421647_.closerToCenterThan(p_421674_.position(), p_259982_))
                            .or(
                                () -> p_421673_.getPoiManager()
                                    .getRandom(
                            ...
                            .ifPresent(p_421661_ -> {
                                ...
                                p_258489_.erase();
                                p_258490_.erase();
                                p_258486_.set(GlobalPos.of(p_421673_.dimension(), p_421661_));
                                if (!p_421661_.closerToCenterThan(p_421674_.position(), p_259982_)) {
                                    p_258484_.set(new WalkTarget(p_421661_, p_259881_, p_259982_));
                                }
                            });
                        return true;
                    }
