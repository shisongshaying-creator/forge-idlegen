...
public class WitherSkull extends AbstractHurtingProjectile {
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_405959_) {
        super.addAdditionalSaveData(p_405959_);
        p_405959_.putBoolean("dangerous", this.isDangerous());
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_409888_) {
        super.readAdditionalSaveData(p_409888_);
        this.setDangerous(p_409888_.getBooleanOr("dangerous", false));
    }
}
