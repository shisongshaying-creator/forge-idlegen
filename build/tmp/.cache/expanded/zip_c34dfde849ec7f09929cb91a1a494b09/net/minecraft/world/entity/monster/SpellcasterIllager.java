...
public abstract class SpellcasterIllager extends AbstractIllager {
    ...
    @Override
    protected void readAdditionalSaveData(ValueInput p_409926_) {
        super.readAdditionalSaveData(p_409926_);
        this.spellCastingTickCount = p_409926_.getIntOr("SpellTicks", 0);
    }

    @Override
    protected void addAdditionalSaveData(ValueOutput p_408199_) {
        super.addAdditionalSaveData(p_408199_);
        p_408199_.putInt("SpellTicks", this.spellCastingTickCount);
    }
