...
public class JigsawBlockEntity extends BlockEntity {
    ...
    protected void saveAdditional(ValueOutput p_409500_) {
        ...
        p_409500_.store("name", ResourceLocation.CODEC, this.name);
        p_409500_.store("target", ResourceLocation.CODEC, this.target);
    ...
    protected void loadAdditional(ValueInput p_409857_) {
        ...
        this.name = p_409857_.read("name", ResourceLocation.CODEC).orElse(EMPTY_ID);
        this.target = p_409857_.read("target", ResourceLocation.CODEC).orElse(EMPTY_ID);
