...
public record PlayerSkin(
    ...
    @Nullable ClientAsset.Texture cape,
    @Nullable ClientAsset.Texture elytra,
    PlayerModelType model,
    boolean secure
) {
    public static PlayerSkin insecure(
        ClientAsset.Texture p_428656_, @Nullable ClientAsset.Texture p_423598_, @Nullable ClientAsset.Texture p_430792_, PlayerModelType p_425395_
    ) {
