...
public class YieldJobSite {
            ...
            p_258916_ -> p_258916_.group(
                ...
                .apply(
                    ...
                    (p_258901_, p_258902_, p_258903_, p_258904_, p_258905_) -> (p_258912_, p_258913_, p_258914_) -> {
                        if (p_258913_.isBaby()) {
                            return false;
                        } else if (!p_258913_.getVillagerData().profession().is(VillagerProfession.NONE)) {
                            return false;
                        } else {
                            ...
                            if (optional.isEmpty()) {
                                ...
                                p_258916_.<List<LivingEntity>>get(p_258903_)
                                    ...
                                    .ifPresent(p_421749_ -> {
                                        ...
                                        p_258905_.erase();
                                        p_258901_.erase();
                                        if (p_421749_.getBrain().getMemory(MemoryModuleType.JOB_SITE).isEmpty()) {
                                            BehaviorUtils.setWalkAndLookTargetMemories(p_421749_, blockpos, p_259768_, 1);
                                            p_421749_.getBrain().setMemory(MemoryModuleType.POTENTIAL_JOB_SITE, GlobalPos.of(p_258912_.dimension(), blockpos));
    ...
    private static boolean nearbyWantsJobsite(Holder<PoiType> p_217511_, Villager p_217512_, BlockPos p_217513_) {
        ...
        if (flag) {
            ...
            Holder<VillagerProfession> holder = p_217512_.getVillagerData().profession();
