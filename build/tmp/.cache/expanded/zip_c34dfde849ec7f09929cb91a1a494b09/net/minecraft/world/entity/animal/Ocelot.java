...
public class Ocelot extends Animal {
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_410680_) {
        super.addAdditionalSaveData(p_410680_);
        p_410680_.putBoolean("Trusting", this.isTrusting());
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_405946_) {
        super.readAdditionalSaveData(p_405946_);
        this.setTrusting(p_405946_.getBooleanOr("Trusting", false));
    }
