...
public class SimpleRegionStorage implements AutoCloseable {
    ...
    public CompoundTag upgradeChunkTag(CompoundTag p_330988_, int p_328203_) {
        ...
        CompoundTag compoundtag = this.dataFixType.updateToCurrentVersion(this.fixerUpper, p_330988_, i);
        return NbtUtils.addCurrentDataVersion(compoundtag);
    }

    public Dynamic<Tag> upgradeChunkTag(Dynamic<Tag> p_329521_, int p_334930_) {
        int i = NbtUtils.getDataVersion(p_329521_, p_334930_);
        Dynamic<Tag> dynamic = this.dataFixType.updateToCurrentVersion(this.fixerUpper, p_329521_, i);
        return NbtUtils.addCurrentDataVersion(dynamic);
    }
