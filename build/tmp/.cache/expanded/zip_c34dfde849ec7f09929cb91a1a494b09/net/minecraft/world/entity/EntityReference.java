...
public final class EntityReference<StoredEntityType extends UniquelyIdentifyable> {
    ...
    @Nullable
    public static <T extends UniquelyIdentifyable> EntityReference<T> of(@Nullable T p_430144_) {
    ...
    @Nullable
    public StoredEntityType getEntity(UUIDLookup<? extends UniquelyIdentifyable> p_395137_, Class<StoredEntityType> p_396644_) {
    ...
    @Nullable
    public StoredEntityType getEntity(Level p_431517_, Class<StoredEntityType> p_426851_) {
    ...
    @Nullable
    public static Entity getEntity(@Nullable EntityReference<Entity> p_430343_, Level p_426440_) {
        return get(p_430343_, p_426440_, Entity.class);
    }

    @Nullable
    public static LivingEntity getLivingEntity(@Nullable EntityReference<LivingEntity> p_423502_, Level p_424628_) {
        return get(p_423502_, p_424628_, LivingEntity.class);
    }

    @Nullable
    public static Player getPlayer(@Nullable EntityReference<Player> p_424138_, Level p_431512_) {
