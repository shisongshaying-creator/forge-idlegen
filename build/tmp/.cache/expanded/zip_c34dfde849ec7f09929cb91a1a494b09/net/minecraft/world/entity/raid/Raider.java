...
public abstract class Raider extends PatrollingMonster {
    ...
    static final Predicate<ItemEntity> ALLOWED_ITEMS = p_421925_ -> !p_421925_.hasPickUpDelay()
        && p_421925_.isAlive()
        && ItemStack.matches(p_421925_.getItem(), Raid.getOminousBannerInstance(p_421925_.registryAccess().lookupOrThrow(Registries.BANNER_PATTERN)));
    ...
    protected void readAdditionalSaveData(ValueInput p_409953_) {
        ...
        if (this.level() instanceof ServerLevel serverlevel) {
            p_409953_.getInt("RaidId").ifPresent(p_421927_ -> {
                this.raid = serverlevel.getRaids().get(p_421927_);
                if (this.raid != null) {
