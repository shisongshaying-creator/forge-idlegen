...
public class IronGolem extends AbstractGolem implements NeutralMob {
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_406569_) {
        super.addAdditionalSaveData(p_406569_);
        p_406569_.putBoolean("PlayerCreated", this.isPlayerCreated());
        this.addPersistentAngerSaveData(p_406569_);
    }

    @Override
    protected void readAdditionalSaveData(ValueInput p_408644_) {
        super.readAdditionalSaveData(p_408644_);
        this.setPlayerCreated(p_408644_.getBooleanOr("PlayerCreated", false));
        this.readPersistentAngerSaveData(this.level(), p_408644_);
    }
