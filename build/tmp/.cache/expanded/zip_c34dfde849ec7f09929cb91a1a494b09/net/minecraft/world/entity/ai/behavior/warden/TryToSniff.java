    ...
    public static BehaviorControl<LivingEntity> create() {
        return BehaviorBuilder.create(
            p_259979_ -> p_259979_.group(
                ...
                .apply(p_259979_, (p_260219_, p_260252_, p_260090_, p_259577_, p_260020_) -> (p_421757_, p_421758_, p_421759_) -> {
                    p_260219_.set(Unit.INSTANCE);
                    p_260090_.setWithExpiry(Unit.INSTANCE, SNIFF_COOLDOWN.sample(p_421757_.getRandom()));
                    p_260252_.erase();
                    p_421758_.setPose(Pose.SNIFFING);
                    return true;
                })
        );
    }
