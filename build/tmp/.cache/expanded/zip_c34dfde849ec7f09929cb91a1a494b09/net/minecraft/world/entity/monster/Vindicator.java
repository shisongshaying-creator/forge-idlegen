...
public class Vindicator extends AbstractIllager {
    ...
    @Override
    protected void addAdditionalSaveData(ValueOutput p_409907_) {
        super.addAdditionalSaveData(p_409907_);
        if (this.isJohnny) {
            p_409907_.putBoolean("Johnny", true);
        }
    }
    ...
    @Override
    protected void readAdditionalSaveData(ValueInput p_410273_) {
        super.readAdditionalSaveData(p_410273_);
        this.isJohnny = p_410273_.getBooleanOr("Johnny", false);
    }
