...
public class Tadpole extends AbstractFish {
    ...
    private void ageUp() {
        if (this.level() instanceof ServerLevel serverlevel) {
            this.convertTo(EntityType.FROG, ConversionParams.single(this, false, false), p_421824_ -> {
                p_421824_.finalizeSpawn(serverlevel, this.level().getCurrentDifficultyAt(p_421824_.blockPosition()), EntitySpawnReason.CONVERSION, null);
                p_421824_.setPersistenceRequired();
                p_421824_.fudgePositionAfterSizeChange(this.getDimensions(this.getPose()));
