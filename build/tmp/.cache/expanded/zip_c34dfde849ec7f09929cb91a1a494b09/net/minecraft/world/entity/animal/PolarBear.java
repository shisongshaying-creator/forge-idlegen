...
public class PolarBear extends Animal implements NeutralMob {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new PanicGoal(this, 2.0, p_405461_ -> p_405461_.isBaby() ? DamageTypeTags.PANIC_CAUSES : DamageTypeTags.PANIC_ENVIRONMENTAL_CAUSES));
    ...
    @Override
    protected void readAdditionalSaveData(ValueInput p_406612_) {
        super.readAdditionalSaveData(p_406612_);
        this.readPersistentAngerSaveData(this.level(), p_406612_);
    }

    @Override
    protected void addAdditionalSaveData(ValueOutput p_407431_) {
        super.addAdditionalSaveData(p_407431_);
        this.addPersistentAngerSaveData(p_407431_);
    }
