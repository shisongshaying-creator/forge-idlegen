...
public class VillagerMakeLove extends Behavior<Villager> {
    ...
    private boolean isBreedingPossible(Villager p_24640_) {
        ...
        Optional<AgeableMob> optional = brain.getMemory(MemoryModuleType.BREED_TARGET).filter(p_421742_ -> p_421742_.getType() == EntityType.VILLAGER);
    ...
    private Optional<Villager> breed(ServerLevel p_24656_, Villager p_24657_, Villager p_24658_) {
        ...
        if (villager == null) {
            ...
            villager.snapTo(p_24657_.getX(), p_24657_.getY(), p_24657_.getZ(), 0.0F, 0.0F);
