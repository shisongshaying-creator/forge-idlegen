...
public class DebugSubscriptions<T> {
    ...
    private static DebugSubscription<?> registerSimple(String p_422904_) {
        return Registry.register(BuiltInRegistries.DEBUG_SUBSCRIPTION, ResourceLocation.withDefaultNamespace(p_422904_), new DebugSubscription(null));
    }
    ...
    private static <T> DebugSubscription<T> registerWithValue(String p_429418_, StreamCodec<? super RegistryFriendlyByteBuf, T> p_428513_) {
        return Registry.register(BuiltInRegistries.DEBUG_SUBSCRIPTION, ResourceLocation.withDefaultNamespace(p_429418_), new DebugSubscription<>(p_428513_));
    }
    ...
    private static <T> DebugSubscription<T> registerTemporaryValue(String p_430317_, StreamCodec<? super RegistryFriendlyByteBuf, T> p_424522_, int p_422345_) {
        return Registry.register(BuiltInRegistries.DEBUG_SUBSCRIPTION, ResourceLocation.withDefaultNamespace(p_430317_), new DebugSubscription<>(p_424522_, p_422345_));
    }
}