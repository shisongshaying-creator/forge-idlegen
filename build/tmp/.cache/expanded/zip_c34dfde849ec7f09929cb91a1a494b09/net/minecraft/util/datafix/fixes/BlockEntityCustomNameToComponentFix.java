...
public class BlockEntityCustomNameToComponentFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(
            ...
            type1,
            p_390226_ -> {
                Optional<String> optional = p_390226_.getOptional(opticfinder);
                return optional.isPresent() && !NAMEABLE_BLOCK_ENTITIES.contains(optional.get())
                    ? ExtraDataFixUtils.cast(type1, p_390226_)
                    : Util.writeAndReadTypedOrThrow(ExtraDataFixUtils.cast(type2, p_390226_), type1, BlockEntityCustomNameToComponentFix::fixTagCustomName);
            }
        );
    }
