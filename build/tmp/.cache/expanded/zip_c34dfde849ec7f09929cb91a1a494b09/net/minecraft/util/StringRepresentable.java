...
public interface StringRepresentable {
    ...
    static <T extends StringRepresentable> Function<String, T> createNameLookup(T[] p_430289_) {
        return createNameLookup(p_430289_, StringRepresentable::getSerializedName);
    }

    static <T> Function<String, T> createNameLookup(T[] p_424390_, Function<T, String> p_313109_) {
        if (p_424390_.length > 16) {
            ...
            return p_421545_ -> p_421545_ == null ? null : map.get(p_421545_);
        } else {
            return p_421543_ -> {
                for (T t : p_424390_) {
    ...
    public static class EnumCodec<E extends Enum<E> & StringRepresentable> extends StringRepresentable.StringRepresentableCodec<E> {
        ...
        public E byName(@Nullable String p_367164_, Supplier<? extends E> p_363447_) {
