...
public class ExtraCodecs {
    ...
    public static final Codec<Vector2f> VECTOR2F = Codec.FLOAT
        .listOf()
        .comapFlatMap(
            p_405238_ -> Util.fixedSize((List<Float>)p_405238_, 2).map(p_405241_ -> new Vector2f(p_405241_.get(0), p_405241_.get(1))),
            p_405237_ -> List.of(p_405237_.x(), p_405237_.y())
        );
    ...
    public static final Codec<Vector3i> VECTOR3I = Codec.INT
        .listOf()
        .comapFlatMap(
            p_405242_ -> Util.fixedSize((List<Integer>)p_405242_, 3).map(p_405240_ -> new Vector3i(p_405240_.get(0), p_405240_.get(1), p_405240_.get(2))),
            p_405239_ -> List.of(p_405239_.x(), p_405239_.y(), p_405239_.z())
        );
    ...
    public static final Codec<Float> NON_NEGATIVE_FLOAT = floatRangeMinInclusiveWithMessage(0.0F, Float.MAX_VALUE, p_425061_ -> "Value must be non-negative: " + p_425061_);
