...
public class DataFixers {
    ...
    private static void addFixers(DataFixerBuilder p_14514_) {
        ...
        p_14514_.addFixer(
            new AddFieldFix(schema268, References.PLAYER, "style", p_421546_ -> p_421546_.createString("minecraft:default"), "locator_bar_icon")
        );
        p_14514_.addFixer(
            new AddFieldFix(schema268, References.ENTITY, "style", p_421547_ -> p_421547_.createString("minecraft:default"), "locator_bar_icon")
        );
        Schema schema269 = p_14514_.addSchema(4531, V4531::new);
        p_14514_.addFixer(new AddNewChoices(schema269, "Added Copper Golem", References.ENTITY));
        Schema schema270 = p_14514_.addSchema(4532, V4532::new);
        p_14514_.addFixer(new AddNewChoices(schema270, "Added Copper Golem Statue Block Entity", References.BLOCK_ENTITY));
        Schema schema271 = p_14514_.addSchema(4533, V4533::new);
        p_14514_.addFixer(new AddNewChoices(schema271, "Added Shelf", References.BLOCK_ENTITY));
        Schema schema272 = p_14514_.addSchema(4535, SAME_NAMESPACED);
        p_14514_.addFixer(new CopperGolemWeatherStateFix(schema272));
        Schema schema273 = p_14514_.addSchema(4537, SAME_NAMESPACED);
        p_14514_.addFixer(new ChunkDeleteLightFix(schema273));
        Schema schema274 = p_14514_.addSchema(4541, SAME_NAMESPACED);
        p_14514_.addFixer(BlockRenameFix.create(schema274, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
        p_14514_.addFixer(ItemRenameFix.create(schema274, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
        Schema schema275 = p_14514_.addSchema(4543, V4543::new);
        p_14514_.addFixer(new AddNewChoices(schema275, "Added Mannequin", References.ENTITY));
        Schema schema276 = p_14514_.addSchema(4544, SAME_NAMESPACED);
        p_14514_.addFixer(new LegacyWorldBorderFix(schema276));
        Schema schema277 = p_14514_.addSchema(4548, SAME_NAMESPACED);
        p_14514_.addFixer(new WorldSpawnDataFix(schema277));
        p_14514_.addFixer(new PlayerRespawnDataFix(schema277));
    }
