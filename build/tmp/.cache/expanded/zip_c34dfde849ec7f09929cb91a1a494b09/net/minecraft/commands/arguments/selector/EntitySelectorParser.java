...
public class EntitySelectorParser {
    ...
    public static <S> boolean allowSelectors(S p_345546_) {
        return p_345546_ instanceof PermissionSource permissionsource && permissionsource.allowsSelectors();
    }
    ...
    public void finalizePredicates() {
        ...
        if (this.level != null) {
            this.predicates.add(p_421090_ -> p_421090_ instanceof ServerPlayer serverplayer && this.level.matches(serverplayer.experienceLevel));
        }
    }

    private Predicate<Entity> createRotationPredicate(MinMaxBounds.FloatDegrees p_426662_, ToFloatFunction<Entity> p_431417_) {
        float f = Mth.wrapDegrees(p_426662_.min().orElse(0.0F));
        float f1 = Mth.wrapDegrees(p_426662_.max().orElse(359.0F));
        return p_175137_ -> {
    ...
    public void setRotX(MinMaxBounds.FloatDegrees p_424962_) {
        this.rotX = p_424962_;
    }
    ...
    public void setRotY(MinMaxBounds.FloatDegrees p_426410_) {
        this.rotY = p_426410_;
    }
