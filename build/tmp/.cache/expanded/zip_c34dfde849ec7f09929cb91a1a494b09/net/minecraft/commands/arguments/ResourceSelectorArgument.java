...
public class ResourceSelectorArgument<T> implements ArgumentType<Collection<Holder.Reference<T>>> {
    ...
    public static <T> Collection<Holder.Reference<T>> parse(StringReader p_393805_, HolderLookup<T> p_396234_) {
        ...
        return p_396234_.listElements().filter(p_397609_ -> matches(s, p_397609_.key().location())).toList();
    }
    ...
    private static boolean isAllowedPatternCharacter(char p_392586_) {
        return ResourceLocation.isAllowedInResourceLocation(p_392586_) || p_392586_ == '*' || p_392586_ == '?';
    }
    ...
    private static boolean matches(String p_396263_, ResourceLocation p_392102_) {
        return FilenameUtils.wildcardMatch(p_392102_.toString(), p_396263_);
    }
