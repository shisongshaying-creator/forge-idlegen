...
public class ResourceOrIdArgument<T> implements ArgumentType<Holder<T>> {
        ...
        NamedRule<StringReader, ResourceOrIdArgument.Result<T, O>> namedrule = dictionary.put(
            atom, Term.alternative(dictionary.named(atom1), dictionary.named(atom2)), p_405044_ -> {
                ...
                if (resourcelocation != null) {
                    return new ResourceOrIdArgument.ReferenceResult<>(ResourceKey.create(p_406976_, resourcelocation));
                } else {
    ...
    @Nullable
    private <O> Holder<T> parse(StringReader p_397396_, Grammar<ResourceOrIdArgument.Result<T, O>> p_406421_, DynamicOps<O> p_406083_) throws CommandSyntaxException {
