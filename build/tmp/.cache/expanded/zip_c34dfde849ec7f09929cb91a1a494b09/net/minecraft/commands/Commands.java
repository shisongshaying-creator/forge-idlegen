...
public class Commands {
    ...
    private static final ClientboundCommandsPacket.NodeInspector<CommandSourceStack> COMMAND_NODE_INSPECTOR = new ClientboundCommandsPacket.NodeInspector<CommandSourceStack>() {
        @Nullable
        @Override
        public ResourceLocation suggestionId(ArgumentCommandNode<CommandSourceStack, ?> p_406913_) {
        ...
        public boolean isRestricted(CommandNode<CommandSourceStack> p_406438_) {
            return p_406438_.getRequirement() instanceof PermissionCheck<?> permissioncheck && permissioncheck.requiredLevel() > 0;
        }
    };
    ...
    public static <T extends PermissionSource> PermissionCheck<T> hasPermission(int p_407189_) {
        return new PermissionSource.Check<>(p_407189_);
    }
