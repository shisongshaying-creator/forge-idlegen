...
public interface StreamCodec<B, V> extends StreamDecoder<B, V>, StreamEncoder<B, V> {
    ...
    static <B, C, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> StreamCodec<B, C> composite(
        ...
        return new StreamCodec<B, C>() {
            ...
            public C decode(B p_397382_) {
                T1 t1 = p_409776_.decode(p_397382_);
                T2 t2 = p_409570_.decode(p_397382_);
                T3 t3 = p_406711_.decode(p_397382_);
                T4 t4 = p_409342_.decode(p_397382_);
                T5 t5 = p_409279_.decode(p_397382_);
                T6 t6 = p_406410_.decode(p_397382_);
                T7 t7 = p_405948_.decode(p_397382_);
                T8 t8 = p_407345_.decode(p_397382_);
                T9 t9 = p_406674_.decode(p_397382_);
                T10 t10 = p_408986_.decode(p_397382_);
                T11 t11 = p_408946_.decode(p_397382_);
                return p_407962_.apply(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11);
            }

            @Override
            public void encode(B p_396343_, C p_395545_) {
                p_409776_.encode(p_396343_, p_407759_.apply(p_395545_));
                p_409570_.encode(p_396343_, p_409883_.apply(p_395545_));
                p_406711_.encode(p_396343_, p_407045_.apply(p_395545_));
                p_409342_.encode(p_396343_, p_406909_.apply(p_395545_));
                p_409279_.encode(p_396343_, p_406008_.apply(p_395545_));
                p_406410_.encode(p_396343_, p_408119_.apply(p_395545_));
                p_405948_.encode(p_396343_, p_407885_.apply(p_395545_));
                p_407345_.encode(p_396343_, p_405989_.apply(p_395545_));
                p_406674_.encode(p_396343_, p_409372_.apply(p_395545_));
                p_408986_.encode(p_396343_, p_408528_.apply(p_395545_));
                p_408946_.encode(p_396343_, p_407134_.apply(p_395545_));
            }
        };
    }
    ...
    static <B, T> StreamCodec<B, T> recursive(final UnaryOperator<StreamCodec<B, T>> p_336362_) {
        return new StreamCodec<B, T>() {
            ...
            @Override
            public T decode(B p_407981_) {
                return this.inner.get().decode(p_407981_);
            }

            @Override
            public void encode(B p_408401_, T p_410054_) {
                this.inner.get().encode(p_408401_, p_410054_);
            }
        };
    }
