...
public class BuiltInRegistries {
    ...
    private static <T extends Registry<?>> void validate(Registry<T> p_260209_) {
        p_260209_.forEach(p_421118_ -> {
            if (p_421118_.keySet().isEmpty()) {
                Util.logAndPauseIfInIde("Registry '" + p_260209_.getKey((T)p_421118_) + "' was empty after loading");
            }

            if (p_421118_ instanceof DefaultedRegistry) {
                ResourceLocation resourcelocation = ((DefaultedRegistry)p_421118_).getDefaultKey();
                Objects.requireNonNull(p_421118_.getValue(resourcelocation), "Missing default of DefaultedMappedRegistry: " + p_421118_.key() + " - " + resourcelocation);
            }
        });
    }
