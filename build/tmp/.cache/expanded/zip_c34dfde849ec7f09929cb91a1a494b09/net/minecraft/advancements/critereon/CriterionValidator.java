...
public class CriterionValidator {
    ...
    public void validate(ContextAwarePredicate p_362235_, ContextKeySet p_368757_, String p_309737_) {
        p_362235_.validate(new ValidationContext(this.reporter.forChild(new ProblemReporter.FieldPathElement(p_309737_)), p_368757_, this.lootData));
    }
    ...
    public void validate(List<ContextAwarePredicate> p_363793_, ContextKeySet p_367816_, String p_312977_) {
        for (int i = 0; i < p_363793_.size(); i++) {
            ...
            contextawarepredicate.validate(
                new ValidationContext(this.reporter.forChild(new ProblemReporter.IndexedFieldPathElement(p_312977_, i)), p_367816_, this.lootData)
            );
        }
    }
}