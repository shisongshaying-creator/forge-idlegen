...
public record Advancement(
    ...
    public void validate(ProblemReporter p_310503_, HolderGetter.Provider p_335087_) {
        this.criteria.forEach((p_404769_, p_404770_) -> {
            CriterionValidator criterionvalidator = new CriterionValidator(p_310503_.forChild(new ProblemReporter.RootFieldPathElement(p_404769_)), p_335087_);
            p_404770_.triggerInstance().validate(criterionvalidator);
        });
    }
        ...
        public Advancement.Builder display(
            ...
            return this.display(
                new DisplayInfo(
                    ...
                    p_138364_,
                    p_138365_,
                    Optional.ofNullable(p_138366_).map(ClientAsset.ResourceTexture::new),
                    p_310090_,
                    p_138368_,
                    p_138369_,
                    p_138370_
        ...
        public Advancement.Builder display(
            ...
            return this.display(
                new DisplayInfo(
                    ...
                    p_138373_,
                    p_138374_,
                    Optional.ofNullable(p_138375_).map(ClientAsset.ResourceTexture::new),
                    p_309840_,
                    p_138377_,
                    p_138378_,
                    p_138379_
