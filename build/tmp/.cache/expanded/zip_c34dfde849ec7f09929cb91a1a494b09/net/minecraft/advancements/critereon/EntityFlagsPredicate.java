    ...
    public boolean matches(Entity p_33697_) {
        if (this.isOnGround.isPresent() && p_33697_.onGround() != this.isOnGround.get()) {
            ...
            if (this.isFlying.isPresent()) {
                boolean flag = p_33697_ instanceof LivingEntity livingentity
            ...
            return !(this.isBaby.isPresent() && p_33697_ instanceof LivingEntity livingentity1) || livingentity1.isBaby() == this.isBaby.get();
        }
    }
